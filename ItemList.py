...
bosslist = ['Kokiri Emerald', 'Goron Ruby', 'Zora Sapphire', 'Forest Medallion', 'Fire Medallion', 'Water Medallion', 'Spirit Medallion', 'Shadow Medallion']
...
def fill_bosses(world, bossCount=8):
    ...
    unplaced_prizes = [item for item in rewards if item.name not in placed_prizes]
