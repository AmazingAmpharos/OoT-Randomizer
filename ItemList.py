...
item_table = {
    ...
    'Kokiri Emerald':                   ('Sigil',    True,  None,
                                            {
                                                'addr2_data': 0x80,
                                                'bit_mask':   0x00040000,
                                                'item_id':    0x6C,
                                            }),
    'Goron Ruby':                       ('Sigil',    True,  None,
                                            {
                                                'addr2_data': 0x81,
                                                'bit_mask':   0x00080000,
                                                'item_id':    0x6D,
                                            }),
    'Zora Sapphire':                    ('Sigil',    True,  None,
                                            {
                                                'addr2_data': 0x82,
                                                'bit_mask':   0x00100000,
                                                'item_id':    0x6E,
                                            }),
    'Forest Medallion':                 ('Sigil',    True,  None,
                                            {
                                                'addr2_data': 0x3E,
                                                'bit_mask':   0x00000001,
                                                'item_id':    0x66,
                                            }),
    'Fire Medallion':                   ('Sigil',    True,  None,
                                            {
                                                'addr2_data': 0x3C,
                                                'bit_mask':   0x00000002,
                                                'item_id':    0x67,
                                            }),
    'Water Medallion':                  ('Sigil',    True,  None,
                                            {
                                                'addr2_data': 0x3D,
                                                'bit_mask':   0x00000004,
                                                'item_id':    0x68,
                                            }),
    'Spirit Medallion':                 ('Sigil',    True,  None,
                                            {
                                                'addr2_data': 0x3F,
                                                'bit_mask':   0x00000008,
                                                'item_id':    0x69,
                                            }),
    'Shadow Medallion':                 ('Sigil',    True,  None,
                                            {
                                                'addr2_data': 0x41,
                                                'bit_mask':   0x00000010,
                                                'item_id':    0x6A,
                                            }),
    'Light Medallion':                  ('Sigil',    True,  None,
                                            {
                                                'addr2_data': 0x40,
                                                'bit_mask':   0x00000020,
                                                'item_id':    0x6B,
