...
item_table = {
    ...
    'Small Key':                        ('SmallKey', True,  0x42, None),
    ...
    'Progressive Wallet':               ('Item',     True,  0x85, None),
    'Progressive Scale':                ('Item',     True,  0x86, None),
    ...
    'Bottle with Red Potion':           ('Item',     True,  0x8C, None),
    'Bottle with Green Potion':         ('Item',     True,  0x8D, None),
    'Bottle with Blue Potion':          ('Item',     True,  0x8E, None),
    'Bottle with Fairy':                ('Item',     True,  0x8F, None),
    'Bottle with Fish':                 ('Item',     True,  0x90, None),
    'Bottle with Blue Fire':            ('Item',     True,  0x91, None),
    'Bottle with Bugs':                 ('Item',     True,  0x92, None),
    'Bottle with Big Poe':              ('Item',     True,  0x93, None),
    'Bottle with Poe':                  ('Item',     True,  0x94, None),
    ...
    'Small Key (Forest Temple)':        ('SmallKey', True,  0xAF, None),
    'Small Key (Fire Temple)':          ('SmallKey', True,  0xB0, None),
    'Small Key (Water Temple)':         ('SmallKey', True,  0xB1, None),
    'Small Key (Spirit Temple)':        ('SmallKey', True,  0xB2, None),
    'Small Key (Shadow Temple)':        ('SmallKey', True,  0xB3, None),
    'Small Key (Bottom of the Well)':   ('SmallKey', True,  0xB4, None),
    'Small Key (Gerudo Training Grounds)':('SmallKey',True, 0xB5, None),
    'Small Key (Gerudo Fortress)':('FortressSmallKey',True, 0xB6, None),
    'Small Key (Ganons Castle)':        ('SmallKey', True,  0xB7, None),
