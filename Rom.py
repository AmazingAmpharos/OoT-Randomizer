...
def patch_rom(world, rom):
    ...
    # Fire Arrows set an event flag and check for it
    Block_code = [0x3C, 0x04, 0x80, 0x12, 0x24, 0x01, 0x00, 0x80, 0x8C, 0x98, 0xB4, 0xA8,
                  0x00, 0x38, 0xC8, 0x24, 0x00, 0x38, 0xC0, 0x25, 0xAC, 0x98, 0xB4, 0xA8]
    rom.write_bytes(0xE9E1B8, Block_code)
    rom.write_byte(0xE9E1D8, 0x13)
