...
def patch_rom(world, rom):
    ...
    kokiriAddresses = [0xE52836, 0xE53A56, 0xE51D4E, 0xE51F3E, 0xE51D96, 0xE51E1E, 0xE51E7E, 0xE51EDE, 0xE51FC6, 0xE51F96, 0xE293B6, 0xE29B8E, 0xE62EDA, 0xE630D6, 0xE62642, 0xE633AA]
    ...
    # Fix warp song learning to work outside of cutscenes
    rom.write_byte(0xB54B3F, 0x03)

    # Fix sun's song learning in all scenes
    rom.write_byte(0xB54E63, 0x03)
