...
def patch_rom(world, rom):
    ...
    # Remove wait time for claim check.
    rom.write_byte(0xAD9379, 0x22)
    ...
    Block_code = [0x59, 0x6f, 0x75, 0x20, 0x67, 0x6f, 0x74, 0x20, 0x61, 0x20, 0x05, 0x41,
                  ...
                  0x20, 0x68, 0x65, 0x6e, 0x73, 0x2e, 0x20, 0x49, 0x74, 0x20, 0x66, 0x69,
...
#    rom.write_bytes(0xBD6C94, [0x0C, 0x22, 0x9E, 0xF0]) #Progressive Items Object Hook, unsure where this case is called
    ...
    rom.write_bytes(0xC8B048, [0x0C, 0x10, 0x02, 0x80, 0x00, 0xA3, 0xAF, 0x21]) #Progressive items from Great Fairies
