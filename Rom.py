...
#    rom.write_bytes(0xB06C2C, [0x0C, 0x10, 0x01, 0x80]) #Save Writing Hook
    ...
    write_bits_to_save(0x00D4 + 0x00 * 0x1C + 0x04 + 0x1, 0x20) # Deku tree switch flag (navi text?)
    ...
    write_bits_to_save(0x00D4 + 0x5B * 0x1C + 0x04 + 0x3, 0x01) # Lost Woods switch flag (???)
