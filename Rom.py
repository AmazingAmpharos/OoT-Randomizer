...
def patch_rom(world, rom):
    ...
    # DMA in extra code
    Block_code = [0xAF, 0xBF, 0x00, 0x1C, 0x3C, 0x04, 0x03, 0x48, 0x3C, 0x05, 0x80, 0x40,
                  0x24, 0x06, 0x10, 0x00, 0x0C, 0x00, 0x02, 0x17, 0x24, 0xAE, 0x10, 0x00,
                  0x0C, 0x10, 0x02, 0x00, 0x3C, 0x02, 0x00, 0x00]
    rom.write_bytes(0x1A70, Block_code)
    Block_code = [0x24, 0x42, 0x74, 0x30, 0x3C, 0x0E, 0x00, 0x01, 0x25, 0xCE, 0xD3, 0x90,
                  0x3C, 0x05, 0x80, 0x01, 0x24, 0xA5, 0xB1, 0x40, 0x01, 0xC2, 0x30, 0x23,
                  0x03, 0xE0, 0x00, 0x08]
    rom.write_bytes(0x3480800, Block_code)

    # Fix checksum (Thanks Nintendo)
    Block_code = [0x87, 0x48, 0x08, 0x21, 0xAD, 0x93, 0xE7, 0x60]
