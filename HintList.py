...
hintTable = {'Hammer':                                                (["the dragon smasher", "a metallic crusher", "the WHAM! weapon"], 'item'),
             'Magic Meter':                                           (["sorcery training", "a stamina scroll", "pixie dust"], 'item'),
             ...
             'Progressive Strength Upgrade':                          (["power gloves", "arm day results", "the heavy lifty"], 'item'),
             'Hover Boots':                                           (["butter boots", "slippery shoes", "spacewalkers"], 'item'),
             'Master Sword':                                          (["evil's bane"], 'item'),
             'Mirror Shield':                                         (["the reflective rampart", "Medusa's weakness", "a silvered surface"], 'item'),
             'Farores Wind':                                          (["teleportation", "relocation magic", "a warp spell", "green wind"], 'item'),
             'Nayrus Love':                                           (["a safe space", "an impregnable aura", "a blue barrier"], 'item'),
             'Ice Arrows':                                            (["the refrigerator rocket", "frostbite bolts", "cold darts", "freezing projectiles"], 'item'),
             'Lens of Truth':                                         (["a lie detector", "true sight", "a detective's tool"], 'item'),
             ...
             'Zeldas Letter':                                         (["an autograph", "royal stationery", "royal snail mail"], 'item'),
             ...
             'Slingshot':                                             (["a seed shooter", "a rubberband", "a child's catapult"], 'item'),
             'Boomerang':                                             (["a banana", "a faithful curved stick"], 'item'),
             'Fire Arrows':                                           (["the furnace firearm", "flame darts", "burning projectiles"], 'item'),
             'Ocarina of Time':                                       (["a blue flute", "a royal instrument"], 'item'),
             'Bottle':                                                (["a glass container", "an empty jar", "something to be filled"], 'item'),
             'Bottle with Letter':                                    (["a call for help", "an SOS jar", "fishy stationery"], 'item'),
             ...
             'Deku Stick Capacity':                                   (["a lumber rack", "more flammable twigs"], 'item'),
             ...
             'Kokiri Sword':                                          (["a butter knife", "a tiny, sharp blade", "a child's blade"], 'item'),
             'Biggoron Sword':                                        (["an unwieldy knife", "a two-handed blade"], 'item'),
             ...
             'Map':                                                   (["a dungeon atlas", "blueprints"], 'item'),
             'Compass':                                               (["a treasure tracker", "a magnetic needle"], 'item'),
             'BossKey':                                               (["a master of unlocking", "a dungeon's final pass"], 'item'),
             'SmallKey':                                              (["a tool for unlocking", "a dungeon pass", "a lock remover", "a legal lockpick", "a portal opener"], 'item'),
             ...
             'Bombs (5)':                                             (["explosives", "sparky boom balls", "fireworks"], 'item'),
             'Bombs (10)':                                            (["explosives", "sparky boom balls", "fireworks"], 'item'),
             'Bombs (20)':                                            (["lots-o-explosives", "sparky boom balls", "fireworks"], 'item'),
             ...
             'Bombchus':                                              (["mice bombs", "hot-headed friends", "remote mines"], 'item'),
             'Bombchus (5)':                                          (["mice bombs", "hot-headed friends", "remote mines"], 'item'),
             'Bombchus (10)':                                         (["mice bombs", "hot-headed friends", "remote mines"], 'item'),
             'Bombchus (20)':                                         (["mice bombs", "hot-headed friends", "remote mines"], 'item'),
