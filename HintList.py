...
hintTable = {
    ...
    'GV Fortress Side -> Carpenter Tent':                 ("a #tent in the valley# covers", None, 'entrance'),
    ...
    'Kak Adult Shooting Gallery':                                ("a #Bow Shooting Gallery#", None, 'region'),
    ...
    'Kak Bombable Grotto':                                 ("#ReDeads# guarding a chest", None, 'region'),
    ...
    'DMC Generic Grotto':                                     ("a #generic grotto#", None, 'region'),
    'DMT Storms Grotto':                                   ("a #generic grotto#", None, 'region'),
    'Kak Back Grotto':                                     ("a #generic grotto#", None, 'region'),
    'HF Market Grotto':                            ("a #generic grotto#", None, 'region'),
    ...
    'LW Generic Grotto':                                ("a #generic grotto#", None, 'region'),
    ...
    'ZR Plateau Bombable Grotto':                       ("a small #Fairy Fountain#", None, 'region'),
