...
hintTable = {
    'Magic Meter':                                           (["mystic training", "a sorcery scroll", "pixie dust", "a green rectangle"], "a Magic Meter", 'item'),
    'Double Defense':                                        (["a white outline", "damage decrease"], "Double Defense", 'item'),
    ...
    'Progressive Hookshot':                                  (["Dampe's keepsake", "the Grapple Beam", "a Link lifter"], "a Hookshot", 'item'),
    'Progressive Strength Upgrade':                          (["power gloves", "metal mittens", "the heavy lifty"], "a Strength Upgrade", 'item'),
    'Progressive Scale':                                     (["a deep dive", "a piece of Zora"], "a Zora Scale", 'item'),
    'Hammer':                                                (["the dragon smasher", "a switch deruster", "the WHAM! weapon"], "the Megaton Hammer", 'item'),
    'Iron Boots':                                            (["sink shoes", "help drowning", "clank cleats"], "the Iron Boots", 'item'),
    'Hover Boots':                                           (["butter boots", "slip shoes", "spacewalkers"], "the Hover Boots", 'item'),
    'Kokiri Sword':                                          (["a butter knife", "a starter slasher", "a child's cutter"], "the Kokiri Sword", 'item'),
    ...
    'Hylian Shield':                                         (["a steel safeguard", "a kid's shell", "a Like Like's lunch crunch"], "a Hylian Shield", 'item'),
    'Mirror Shield':                                         (["the reflective rampart", "Medusa's weakness", "a silvered surface"], "the Mirror Shield", 'item'),
    'Farores Wind':                                          (["teleportation", "a relocation rune", "a green ball"], "Farore's Wind", 'item'),
    'Nayrus Love':                                           (["a safe space", "an impregnable aura", "a blue barrier", "the Byrna barrier"], "Nayru's Love", 'item'),
    'Dins Fire':                                             (["an inferno", "a heat wave", "a red ball"], "Din's Fire", 'item'),
    'Fire Arrows':                                           (["the furnace firearm", "the flame flinger", "a magma missile"], "the Fire Arrows", 'item'),
    'Ice Arrows':                                            (["the refrigerator rocket", "the frostbite flinger", "an iceberg maker"], "the Ice Arrows", 'item'),
    'Light Arrows':                                          (["the shining shot", "the luminous launcher", "Ganondorf's bane"], "the Light Arrows", 'item'),
    'Lens of Truth':                                         (["a lie detector", "a gambling cheat", "a ghost tracker"], "the Lens of Truth", 'item'),
    ...
    'Goron Tunic':                                           (["ruby robes", "fireproof fabric", "cooking clothing"], "a Goron Tunic", 'item'),
    ...
    'Eponas Song':                                           (["an equestrian etude", "a Malon melody"], "Epona's Song", 'item'),
    'Sarias Song':                                           (["a song of dancing Gorons", "Saria's phone number"], "Saria's Song", 'item'),
    'Suns Song':                                             (["Sunny Day", "a Skulltula summoning song", "the ReDead's bane"], "the Sun's Song", 'item'),
    'Song of Time':                                          (["a song 7 years long", "the tune of Somaria"], "the Song of Time", 'item'),
    ...
    'Bolero of Fire':                                        (["a song of lethal lava", "a red spark trail", "a volcano verse"], "the Bolero of Fire", 'item'),
    ...
    'Bottle with Letter':                                    (["a call for help", "the note that Mweeps", "an SOS call"], "Ruto's Letter", 'item'),
    ...
    'Gerudo Membership Card':                                (["a girl club membership", "a woman license"], "the Gerudo Card", 'item'),
    ...
    'Recovery Heart':                                        (["a free heal", "short-term love", "a Band-Aid"], "a Recovery Heart", 'item'),
    ...
    'Rupees (5)':                                            (["a common coin", "a nickel", "a blue gem"], "a Blue Rupee", 'item'),
    'Rupees (20)':                                           (["couch cash", "a red gem"], "a Red Rupees", 'item'),
    'Rupees (50)':                                           (["big bucks", "a purple gem", "wealth"], "a Purple Rupee", 'item'),
    'Rupees (200)':                                          (["a juicy jackpot", "a yellow gem", "great wealth"], "a Huge Rupee", 'item'),
    ...
    'Bombs (5)':                                             (["a few explosives", "a few blast balls", "a few black spheres"], "Bombs (5 pieces)", 'item'),
    'Bombs (10)':                                            (["some explosives", "some blast balls", "some black spheres"], "Bombs (10 pieces)", 'item'),
    'Bombs (20)':                                            (["lots-o-explosives", "plenty of blast balls", "plenty of black spheres"], "Bombs (20 pieces)", 'item'),
    ...
    'Water Temple Boss Key Chest':                           ("deep under #the lake#, the gilded chest contains", "the #Water Temple Boss Key Chest# holds", 'location'),
    'Water Temple MQ Boss Key Chest':                        ("deep under #the lake#, the gilded chest contains", "the #Water Temple Boss Key Chest# holds", 'location'),
    ...
    'Haunted Wasteland Structure Chest':                     (["deep in the #Wasteland# is", "beneath #the sands#, flame reveals"], None, 'location'),
