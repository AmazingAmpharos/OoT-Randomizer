...
hintTable = {'Hammer':                                                (["the dragon smasher", "a metallic crusher", "the WHAM! weapon"], 'item'),
             ...
             'Master Sword':                                          (["evil's bane", "the sword in the stone"], 'item'),
             ...
             'Song of Time':                                          (["a song 7 years long", "a song from a blue flute", "a tune to move blocks"], 'item'),
             ...
             'Slingshot':                                             (["a seed shooter", "child's projectiles"], 'item'),
             'Boomerang':                                             (["a banana", "a faithful curved stick", "Jabu Jabu's prize"], 'item'),
             'Fire Arrows':                                           (["the furnace firearm", "flame darts", "burning projectiles", "the sun's gift"], 'item'),
             'Ocarina of Time':                                       (["a blue flute", "a royal instrument"], 'item'),
             'Bottle':                                                (["a fairy prison", "a glass container", "an empty jar", "something to be filled"], 'item'),
             'Bottle with Letter':                                    (["a call for help", "an SOS jar", "fishy stationary"], 'item'),
             ...
             'Progressive Scale':                                     (["Zora's Flippers", "a dive enhancer"], 'item'),
             'Stone of Agony':                                        (["an empty chest", "a vibrating rock", "a clue finder"], 'item'),
             'Eponas Song':                                           (["an equestrian etude", "a ranch song", "Malon's tune"], 'item'),
             ...
             'Suns Song':                                             (["Sunny Day", "a time advancer", "a day/night melody", "the redead's keepsake", "the gibdo's bane"], 'item'),
             ...
             'Serenade of Water':                                     (["a song of a damp ditch", "a blue warp song", "the lake's tune", "ice cavern's melody"], 'item'),
             'Heart Container':                                       (["a lot of love", "a Valentine's gift", "every boss' reward"], 'item'),
             ...
             'Rupee (1)':                                             (["rare riches", "a green gem"], 'item'),
             ...
             'Light Arrows':                                          (["the shining shot", "glowing darts", "Ganondorf's bane", "Zelda's final gift"], 'item'),
             'Kokiri Sword':                                          (["a butter knife", "a tiny, sharp blade"], 'item'),
             'Biggoron Sword':                                        (["a shield disabler", "a two-handed blade", "Biggoron's product", "an epic trade's end"], 'item'),
             ...
             '10 Big Poes':                                           (["They say that Big Poes leads&to", "They say that ghost&hunters are rewarded&with"], 'alwaysLocation'),
