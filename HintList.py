...
hintTable = {
    ...
    'Market Bombchu Bowling Bomb Bag':                                 ("the #first explosive prize# is", None, 'minigame'),
    'Market Bombchu Bowling Piece of Heart':                           ("the #second explosive prize# is", None, 'minigame'),
    ...
    'Graveyard Composer Grave Chest':                                     (["in the #Composers' Grave#, darkness hides", "the #Composer Brothers# hid"], None, ['overworld', 'sometimes']),
    ...
    'Zoras Domain King Zora':                                         ("unfreezing #King Zora# grants", None, ['overworld', 'sometimes']),
    ...
    'Water Temple MQ GS North Basement':                        ("deep under #the lake#, the locked spider holds", None, ['dungeon', 'sometimes']),
    ...
    'Forest Stage':                                             ("the #Lost Woods Stage#", None, 'region'),
