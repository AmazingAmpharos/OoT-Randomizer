...
hintTable = {
    ...
    'GS Water Temple South Basement':                           ("a spider behind a #gate under the lake# holds", "a spider behind a #gate in the Water Temple# holds", ['dungeon', 'sometimes']),
    ...
    'GS Water Temple MQ North Basement':                        ("the #locked spider under the lake# holds", "the #locked spider in the Water Temple# holds", ['dungeon', 'sometimes']),
    'GS Water Temple MQ South Basement':                        ("a spider behind a #gate under the lake# holds", "a spider behind a #gate in the Water Temple# holds", ['dungeon', 'sometimes']),
    ...
    'Desert Colossus -> Colossus Fairy':                        ("a #fractured desert wall# hides", None, 'entrance'),
    'Ganons Castle Grounds -> Ganons Castle Fairy':             ("a #heavy pillar# outside the castle obstructs", None, 'entrance'),
    'Zoras Fountain -> Zoras Fountain Fairy':                   ("a #fountain wall# hides", None, 'entrance'),
