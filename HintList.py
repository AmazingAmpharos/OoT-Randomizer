...
hintTable = {
    ...
    'Kak Anju as Child':                                           (["#wrangling roosters# rewards", "#bundling birds# yields", "#chucking chickens# gifts"], "#collecting cuccos# rewards", ['overworld', 'sometimes']),
    ...
    'Graveyard Heart Piece Grave Chest':                           ("#calling the sun underground# reveals", "playing #Sun's Song# in a grave spawns", ['overworld', 'sometimes']),
    'GC Maze Left Chest':                                          ("the #chest locked in the stone maze# contains", "in #Goron City# the hammer unlocks", ['overworld', 'sometimes']),
    ...
    'DMC Deku Scrub':                                              ("a solitary #scrub in the crater# sells", None, ['overworld', 'sometimes']),
    'DMC GS Crate':                                                ("a spider in a #crate in a volcano# holds", None, ['overworld', 'sometimes']),
    ...
    'Gerudo Training Grounds Underwater Silver Rupee Chest':       ("the #thieves' underwater training# rewards", "those who seek #sunken silver rupees# will find", ['dungeon', 'sometimes']),
    'Gerudo Training Grounds MQ Underwater Silver Rupee Chest':    ("the #thieves' underwater training# rewards", "those who seek #sunken silver rupees# will find", ['dungeon', 'sometimes']),
    ...
    'Graveyard Hookshot Chest':                                    ("a #ghost's life's work# is", "#dead Dampe's first prize# is", 'exclude'),
    ...
    'Market Dog Lady':                                             ("#puppy lovers# will find", "#rescuing Richard the Dog# is rewarded with", 'exclude'),
    ...
    'Market Shooting Gallery':                                     ("#shooting in youth# grants", None, 'exclude'),
    'Kak Shooting Gallery':                                        ("#shooting in maturity# grants", None, 'exclude'),
