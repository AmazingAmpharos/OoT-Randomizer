...
hintTable = {
    ...
    'Sheik Forest Song':                                        ("#in a meadow# Sheik teaches", None, ['song', 'sometimes']),
    ...
    'Anjus Chickens':                                           ("#collecting cuccos# rewards", None, ['overworld', 'sometimes']),
    ...
    'Boomerang Chest':                                          ("a school of #stingers in the belly of a deity# guard", None, ['dungeon', 'sometimes']),
    ...
    'GS Jabu Jabu MQ Boomerang Room':                           ("a spider under a #temporal stone in the belly of a deity# holds", None, ['dungeon', 'sometimes']),
    'Jabu Jabus Belly MQ Cow':                                  ("a #cow in the belly of a deity# gifts", None, ['dungeon', 'sometimes']),
    'Forest Temple Floormaster Chest':                          ("#shadows in the forest# guard", "a #Floormaster in Forest Temple# guards", ['dungeon', 'sometimes']),
    'Forest Temple MQ NE Outdoors Lower Chest':                 ("a chest on an #island in the forest# contains", "a chest on an #island in Forest Temple# contains", ['dungeon', 'sometimes']),
    ...
    'Water Temple River Chest':                                 ("beyond the #river under the lake# waits", "beyond the #river in Water Temple# waits", ['dungeon', 'sometimes']),
    'Water Temple Boss Key Chest':                              ("dodging #rolling boulders under the lake# leads to", "dodging #rolling boulders in Water Temple# leads to", ['dungeon', 'sometimes']),
    'GS Water Temple South Basement':                           ("a spider behind a #gate under the lake# holds", "a spider behind a #gate in Water Temple# holds", ['dungeon', 'sometimes']),
    'Water Temple MQ Freestanding Key':                         ("hidden in a #box under the lake# lies", "hidden in a #box in Water Temple# lies", ['dungeon', 'sometimes']),
    'GS Water Temple MQ North Basement':                        ("the #locked spider under the lake# holds", "the #locked spider in Water Temple# holds", ['dungeon', 'sometimes']),
    'GS Water Temple MQ South Basement':                        ("a spider behind a #gate under the lake# holds", "a spider behind a #gate in Water Temple# holds", ['dungeon', 'sometimes']),
    ...
    'Bottom of the Well Defeat Boss':                           ("#Dead Hand in the well# holds", None, ['dungeon', 'sometimes']),
    ...
    'Spirit Temple MQ Child Center Chest':                      ("a #temporal paradox in the colossus# yields", "a #temporal paradox in Spirit Temple# yields", ['dungeon', 'sometimes']),
    'Spirit Temple MQ Lower Adult Right Chest':                 ("a #symphony in the colossus# yields", "a #symphony in Spirit Temple# yields", ['dungeon', 'sometimes']),
    'GS Spirit Temple MQ Lower Adult Right':                    ("a #spider's symphony in the colossus# yields", "a #spider's symphony in Spirit Temple# yields", ['dungeon', 'sometimes']),
    'Shadow Temple Hidden Floormaster Chest':                   ("#shadows in an invisible maze# guard", "a #Floormaster in Shadow Temple# guards", ['dungeon', 'sometimes']),
    ...
    'Gerudo Valley Far Side -> Gerudo Valley Storms Grotto':    ("a #storm in the valley# reveals", None, 'entrance'),
    ...
    'Kakariko Village -> Bottom of the Well':                   ("inside the #well of a village#, one can find", None, 'entrance'),
    ...
    'Carpenter Tent':                                           ("the #Carpenters' tent#", None, 'region'),
    'Castle Town Rupee Room':                                   ("the #Guard House#", None, 'region'),
    'Castle Town Mask Shop':                                    ("the #Happy Mask Shop#", None, 'region'),
    'Castle Town Bombchu Bowling':                              ("the #Bombchu Bowling Alley#", None, 'region'),
