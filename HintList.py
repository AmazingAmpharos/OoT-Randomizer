...
hintTable = {'Hammer':                                                   ("the dragon smasher", 'item'),
             ...
             'Bottle with Big Poe':                                      ("a supersized spirit", 'item'),
             ...
             'Rupee (Treasure Chest Game)':                              ("the dollar of defeat", 'item'),
             ...
             'Deku Stick (1)':                                           ("a breakable branch", 'item'),
             ...
             'Ocarina of Time':                                          ("They say the treasure thrown&by Princess Zelda&is", 'alwaysLocation'),
             ...
             'GS Hyrule Castle Grotto':                                  ("They say that a storm&near the castle&reveals", 'location'),
             'GS Hyrule Field Near Gerudo Valley':                       ("They say that buried near&near the valley a spider&holds", 'location'),
             'GS Zora\'s Fountain Hidden Cave':                          ("They say a spider high&above the icy waters&holds", 'location'),
             'Deku Tree MQ After Spinning Log Chest':                    ("Within a tree, a temporal stone&contains", 'location'),
             'GS Jabu Jabu MQ Invisible Enemies Room':                   ("In the belly of a deity, a spider&surrounded by shadows&holds", 'location'),
             ...
             'Fire Temple MQ West Tower Top Chest':                      ("They say that the highest&chest in the crater&holds", 'location'),
             ...
             'Water Temple MQ Boss Key Chest':                           ("Deep under the lake,&the gilded chest&contains", 'location'),
             'Water Temple MQ Freestanding Key':                         ("Deep under the lake,&the apparent key&is really", 'location'),
             'GS Water Temple MQ North Basement':                        ("Deep under the lake,&the locked skull&holds", 'location'),
             ...
             'Gerudo Training Grounds MQ Ice Arrows Chest':              ("They say that past all the locked&doors is", 'location'),
             ...
             'Spirit Temple MQ Child Center Chest':                      ("Within the Colossus&a temporal paradox&yields", 'location'),
             'Spirit Temple MQ Lower Adult Right Chest':                 ("Within the Colossus&a symphony&yields", 'location'),
             'GS Spirit Temple MQ Lower Adult Right':                    ("Within the Colossus&a spider\'s symphony&yields", 'location'),
             'Shadow Temple Hidden Floormaster Chest':                   ("They say in a maze&guarded by shadows&hides", 'location'),
             'Shadow Temple MQ Bomb Flower Chest':                       ("They say in a maze&guarded by shadows&hides", 'location'),
