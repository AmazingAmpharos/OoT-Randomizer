...
hintTable = {
    ...
    'Midos House':                                              ("Mido's house", None, 'region'),
    'Sarias House':                                              ("Saria's House", None, 'region'),
    ...
    'Composers Grave':                                          ("the #Composers' Grave#", None, 'region'),
    ...
    'Tektite Grotto':                                           ("a pool guarded by a #Tektite#", None, 'region'),
