...
def global_rules(world):
    ...
    set_rule(world.get_location('Skull Kid'), lambda state: state.can_play('Sarias Song') and state.has('Ocarina'))
    ...
    set_rule(world.get_entrance('Fire Temple Early Climb'), lambda state: state.has('Small Key (Fire Temple)', 3) and state.has('Progressive Strength Upgrade') and (state.has_explosives() or ((state.has('Bow') or state.has('Progressive Hookshot')) and state.is_adult())))
    ...
    set_rule(world.get_location('Volvagia'), lambda state: state.has('Hammer') and state.is_adult() and state.has('Boss Key (Fire Temple)') and (state.has('Hover Boots') or (state.can_reach('Fire Temple Upper') and (state.can_play('Song of Time') or state.has_explosives()))))
    set_rule(world.get_location('Volvagia Heart'), lambda state: state.has('Hammer') and state.is_adult() and state.has('Boss Key (Fire Temple)') and (state.has('Hover Boots') or (state.can_reach('Fire Temple Upper') and (state.can_play('Song of Time') or state.has_explosives()))))
    ...
    set_rule(world.get_entrance('Water Temple Entrance'), lambda state: state.is_adult() and (state.has('Zora Tunic') or (state.has('Progressive Wallet', 2) and state.has_bottle() and state.can_play('Zeldas Lullaby'))) and state.has('Iron Boots') and state.has('Progressive Hookshot'))
    ...
    set_rule(world.get_location('Gerudo Training Grounds Underwater Silver Rupee Chest'), lambda state: state.has('Progressive Hookshot') and state.can_play('Song of Time') and state.has('Iron Boots') and state.has('Zora Tunic') and state.is_adult())
    ...
    set_rule(world.get_location('GS9'), lambda state: state.has('Slingshot') or state.has_explosives() or state.has('Boomerang') or (state.has('Dins Fire') and state.has('Magic Meter')))
    set_rule(world.get_location('GS11'), lambda state: state.has('Boomerang') and state.has_explosives())
    set_rule(world.get_location('GS12'), lambda state: (state.has('Boomerang') and state.has_explosives()) or (state.has('Progressive Hookshot') and state.is_adult()))
    set_rule(world.get_location('GS13'), lambda state: (state.has('Hammer') and state.has_fire_source() and state.has('Progressive Hookshot') and state.is_adult()) or (state.has('Boomerang') and state.has_explosives() and state.has('Dins Fire') and state.has('Magic Meter')))
    set_rule(world.get_location('GS16'), lambda state: state.has('Boomerang') and state.has_explosives())
    ...
    set_rule(world.get_location('GS26'), lambda state: state.has('Slingshot') or state.has_explosives())
    ...
    set_rule(world.get_location('GS30'), lambda state: state.has_bottle() and (state.has_explosives() or state.has('Progressive Strength Upgrade')))
    set_rule(world.get_location('GS31'), lambda state: state.can_blast_or_smash())
    ...
    set_rule(world.get_location('GS34'), lambda state: state.has_explosives())
    set_rule(world.get_location('GS35'), lambda state: state.is_adult())
    set_rule(world.get_location('GS37'), lambda state: state.can_play('Bolero of Fire') and state.has_bottle())
    set_rule(world.get_location('GS39'), lambda state: state.has_explosives() or (state.has('Boomerang') or state.has('Slingshot') and state.has('Progressive Strength Upgrade')) or (state.has('Dins Fire') and state.has('Magic Meter')) or (state.is_adult and (state.has('Progressive Hookshot') or state.has('Bow') or state.has('Biggoron Sword'))))
    set_rule(world.get_location('GS41'), lambda state: (state.has('Progressive Hookshot') and state.is_adult()) or (state.has('Boomerang') and (state.has_explosives() or state.has('Progressive Strength Upgrade'))))
    ...
    set_rule(world.get_location('GS50'), lambda state: state.has('Progressive Strength Upgrade', 2) and state.can_blast_or_smash() and state.has('Progressive Hookshot'))
# Jabu Jabu GS need no reqs becuase the access reqs for their zones cover them.
    ...
    set_rule(world.get_location('GS65'), lambda state: state.has('Small Key (Fire Temple)', 1) and state.can_play('Song of Time'))
    set_rule(world.get_location('GS66'), lambda state: state.has_explosives())
    ...
    set_rule(world.get_location('GS73'), lambda state: state.has_explosives() and state.has('Magic Meter'))
    set_rule(world.get_location('GS74'), lambda state: state.can_play('Song of Time') and state.has('Small Key (Water Temple)', 6))
    ...
    set_rule(world.get_location('GS93'), lambda state: state.has_bottle() and state.can_play('Requiem of Spirit'))
    set_rule(world.get_location('GS94'), lambda state: state.has('Progressive Hookshot') and state.is_adult())
    set_rule(world.get_location('GS95'), lambda state: ((state.has('Magic Bean') and state.can_play('Requiem of Spirit')) or state.has('Progressive Hookshot', 2)) and state.is_adult())
    ...
    set_rule(world.get_location('GS99'), lambda state: state.can_play('Song of Time') and (state.has('Bow') or state.has('Progressive Hookshot') or state.has_explosives()))
