...
def global_rules(world):
    ...
    set_rule(world.get_location('10 Big Poes'), lambda state: state.has('Bow') and state.has('Epona') and state.is_adult())
    ...
    set_rule(world.get_location('Frog Ocarina Game'), lambda state: state.has('Zeldas Lullaby') and state.has('Sarias Song') and state.has('Suns Song') and state.has('Eponas Song') and state.has('Song of Time'))
    ...
    set_rule(world.get_location('King Zora Thawed'), lambda state: state.has('Bottle'))
