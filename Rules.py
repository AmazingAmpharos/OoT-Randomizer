...
def global_rules(world):
    ...
    set_rule(world.get_location('Sheik in Ice Cavern'), lambda state: state.has('Bottle') and state.has('Iron Boots') and state.is_adult())
    ...
    set_rule(world.get_entrance('Fortress Entrance'), lambda state: state.has('Bow') and state.is_adult())
    ...
    set_rule(world.get_location('Spirit Temple Child Climb East Chest'), lambda state: state.has('Bomb Bag') or (state.has('Small Key (Spirit Temple)', 3) and state.has('Progressive Strength Upgrade', 2) and state.is_adult() and (state.has('Progressive Hookshot') or state.has('Bow'))) or (state.has('Small Key (Spirit Temple)', 5) and state.has('Requiem of Spirit') and (state.has('Boomerang') or state.has('Slingshot'))))
    set_rule(world.get_location('Spirit Temple Child Climb North Chest'), lambda state: state.has('Bomb Bag') or (state.has('Small Key (Spirit Temple)', 3) and state.has('Progressive Strength Upgrade', 2) and state.is_adult() and (state.has('Progressive Hookshot') or state.has('Bow'))) or (state.has('Small Key (Spirit Temple)', 5) and state.has('Requiem of Spirit') and (state.has('Boomerang') or state.has('Slingshot'))))
...
# Jabu Jabu GS need no reqs becuase the access reqs for their zones cover them.
    ...
    set_rule(world.get_location('GS87'), lambda state: state.has('Bottle'))
    ...
    set_rule(world.get_location('GS93'), lambda state: state.has('Bottle') and state.has('Requiem of Spirit'))
