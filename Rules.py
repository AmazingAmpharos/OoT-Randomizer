...
def global_rules(world):
    ...
    set_rule(world.get_location('Lake Hylia Sun'), lambda state: state.has('Progressive Hookshot', 2) and state.has('Boss Key (Water Temple)') and state.has('Bow') and state.is_adult())
