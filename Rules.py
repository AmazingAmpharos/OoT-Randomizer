...
# Jabu Jabu GS need no reqs becuase the access reqs for their zones cover them.
    ...
    if world.custom_logic:
        ...
        set_rule(world.get_location('Dodongos Cavern End of Bridge Chest'), lambda state: state.has('Bomb Bag') or (state.is_adult() and state.has('Hammer')))
        ...
        set_rule(world.get_location('Ganons Castle Spirit Trial Second Chest'), lambda state: state.has('Progressive Hookshot') and state.has('Bomb Bag'))
