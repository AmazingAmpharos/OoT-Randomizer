...
def global_rules(world):
    ...
    set_rule(world.get_entrance('Dodongos Cavern Rocks'), lambda state: state.can_blast() or state.has('Progressive Strength Upgrade'))
    set_rule(world.get_entrance('Dodongos Cavern Lobby'), lambda state: state.has('Bomb Bag') or state.has('Progressive Strength Upgrade'))
    ...
    set_rule(world.get_entrance('Forest Temple Straightened Hall'), lambda state: state.has('Small Key (Forest Temple)', 2))
    set_rule(world.get_entrance('Forest Temple Drop to Falling Room'), lambda state: state.has('Small Key (Forest Temple)', 5))
    ...
    set_rule(world.get_location('Adult Fishing'), lambda state: state.is_adult and (state.has('Progressive Hookshot') or state.has('Bomb Bag')))
