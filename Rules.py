...
def global_rules(world):
    ...
    set_rule(world.get_entrance('Bottom of the Well'), lambda state: state.can_play('Song of Storms') and (world.dungeon_mq['BW'] or (state.has_slingshot() or state.has_sticks() or state.has_explosives() or state.has('Kokiri Sword') or state.can_use('Dins Fire') or (world.logic_tricks and (state.has_nuts() or state.has('Boomerang'))))))
...
def dung_rules_fotmq(world):
    ...
    set_rule(world.get_entrance('Forest Temple Well Connection'), lambda state: state.can_use('Iron Boots') or state.can_use('Longshot') or state.has('Progressive Scale', 2) or (world.logic_tricks and state.can_use('Hookshot')))
...
def dung_rules_gtgmq(world):
    ...
    set_rule(world.get_entrance('Gerudo Training Grounds Longshot Target'), lambda state: state.can_use('Longshot') or (world.logic_tricks and state.can_use('Hookshot')))
