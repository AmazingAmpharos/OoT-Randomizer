...
location_table = {
    ...
    "LW Near Shortcut Grotto Chest":                         ("Chest",       0x3E,  0x14, None,                     ("the Lost Woods", "Forest", "Grottos")),
    ...
    "Dodongos Cavern MQ GS Larva Room":                    ("GS Token",    0x01,  0x10, None,                     ("Dodongo's Cavern", "Skulltulas",)),
    ...
    "ZR Near Grottoes Gossip Stone":                              ("GossipStone", None,  None, None,                     None),
    ...
    "LW Near Shortcut Grotto Gossip Stone":                       ("GossipStone", None,  None, None,                     None),
