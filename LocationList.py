...
location_table = {
    "KF Chest":                              ("Chest",       0x55,  0x00, None,                     ("Kokiri Forest", "Forest",)),
    "KF Mido Chest Top Left":                             ("Chest",       0x28,  0x00, None,                     ("Kokiri Forest", "Forest",)),
    "KF Mido Chest Top Right":                            ("Chest",       0x28,  0x01, None,                     ("Kokiri Forest", "Forest",)),
    "KF Mido Chest Bottom Left":                          ("Chest",       0x28,  0x02, None,                     ("Kokiri Forest", "Forest",)),
    "KF Mido Chest Bottom Right":                         ("Chest",       0x28,  0x03, None,                     ("Kokiri Forest", "Forest",)),
    ...
    "LW Grotto Chest":                 ("Chest",       0x3E,  0x14, None,                     ("the Lost Woods", "Forest", "Grottos")),
    ...
    "LW Fairy Ocarina Item":                                 ("Cutscene",    0xFF,  0x02, None,                     ("the Lost Woods", "Forest",)),
    "ZF Great Fairy":                     ("Cutscene",    0xFF,  0x10, None,                     ("Zora's Fountain", "Fairies",)),
    "HC Great Fairy":                      ("Cutscene",    0xFF,  0x11, None,                     ("Hyrule Castle", "Castle Town", "Fairies")),
    "Colossus Great Fairy":                    ("Cutscene",    0xFF,  0x12, None,                     ("Desert Colossus", "Fairies",)),
    "DMT Great Fairy":                    ("Cutscene",    0xFF,  0x13, None,                     ("Death Mountain Trail", "Death Mountain", "Fairies")),
    "DMC Great Fairy":                             ("Cutscene",    0xFF,  0x14, None,                     ("Death Mountain Crater", "Death Mountain", "Fairies",)),
    "OGC Great Fairy":                      ("Cutscene",    0xFF,  0x15, None,                     ("outside Ganon's Castle", "Castle Town", "Fairies")),
    ...
    "HC Malon Egg":                                       ("NPC",         0x5F,  0x47, None,                     ("Hyrule Castle", "Castle Town",)),
    "HC Zeldas Letter":                                   ("NPC",         None,  None, None,                     ("Hyrule Castle", "Castle Town",)),
    ...
    "ZR Lower Freestanding PoH":               ("Collectable", 0x54,  0x04, None,                     ("Zora's River",)),
    "ZR Upper Freestanding PoH":               ("Collectable", 0x54,  0x0B, None,                     ("Zora's River",)),
    ...
    "HF GS Grotto Near Kak":         ("GS Token",    0x0A,  0x02, None,                     ("Hyrule Field", "Skulltulas", "Grottos")),
    ...
    "LW GS Bean Patch Near Stage":                  ("GS Token",    0x0D,  0x02, None,                     ("the Lost Woods", "Skulltulas",)),
    "LW GS Above Stage":                            ("GS Token",    0x0D,  0x04, None,                     ("the Lost Woods", "Skulltulas",)),
    ...
    "HC GS Grotto":                              ("GS Token",    0x0E,  0x02, None,                     ("Hyrule Castle", "Skulltulas", "Grottos")),
    ...
    "DMT GS Near Kakariko Village":        ("GS Token",    0x0F,  0x04, None,                     ("Death Mountain Trail", "Skulltulas",)),
    ...
    "Market Bombchu Shop Item 1":                           ("Shop",        0x32,  0x30, (shop_address(2, 0), None), ("the Market", "Castle Town", "Shops")),
    "Market Bombchu Shop Item 2":                           ("Shop",        0x32,  0x31, (shop_address(2, 1), None), ("the Market", "Castle Town", "Shops")),
    "Market Bombchu Shop Item 3":                           ("Shop",        0x32,  0x32, (shop_address(2, 2), None), ("the Market", "Castle Town", "Shops")),
    "Market Bombchu Shop Item 4":                           ("Shop",        0x32,  0x33, (shop_address(2, 3), None), ("the Market", "Castle Town", "Shops")),
    "Market Bombchu Shop Item 5":                           ("Shop",        0x32,  0x34, (shop_address(2, 4), None), ("the Market", "Castle Town", "Shops")),
    "Market Bombchu Shop Item 6":                           ("Shop",        0x32,  0x35, (shop_address(2, 5), None), ("the Market", "Castle Town", "Shops")),
    "Market Bombchu Shop Item 7":                           ("Shop",        0x32,  0x36, (shop_address(2, 6), None), ("the Market", "Castle Town", "Shops")),
    "Market Bombchu Shop Item 8":                           ("Shop",        0x32,  0x37, (shop_address(2, 7), None), ("the Market", "Castle Town", "Shops")),

    "Market Potion Shop Item 1":                            ("Shop",        0x31,  0x30, (shop_address(3, 0), None), ("the Market", "Castle Town", "Shops")),
    "Market Potion Shop Item 2":                            ("Shop",        0x31,  0x31, (shop_address(3, 1), None), ("the Market", "Castle Town", "Shops")),
    "Market Potion Shop Item 3":                            ("Shop",        0x31,  0x32, (shop_address(3, 2), None), ("the Market", "Castle Town", "Shops")),
    "Market Potion Shop Item 4":                            ("Shop",        0x31,  0x33, (shop_address(3, 3), None), ("the Market", "Castle Town", "Shops")),
    "Market Potion Shop Item 5":                            ("Shop",        0x31,  0x34, (shop_address(3, 4), None), ("the Market", "Castle Town", "Shops")),
    "Market Potion Shop Item 6":                            ("Shop",        0x31,  0x35, (shop_address(3, 5), None), ("the Market", "Castle Town", "Shops")),
    "Market Potion Shop Item 7":                            ("Shop",        0x31,  0x36, (shop_address(3, 6), None), ("the Market", "Castle Town", "Shops")),
    "Market Potion Shop Item 8":                            ("Shop",        0x31,  0x37, (shop_address(3, 7), None), ("the Market", "Castle Town", "Shops")),

    "Market Bazaar Item 1":                                 ("Shop",        0x2C,  0x30, (shop_address(4, 0), None), ("the Market", "Castle Town", "Shops")),
    "Market Bazaar Item 2":                                 ("Shop",        0x2C,  0x31, (shop_address(4, 1), None), ("the Market", "Castle Town", "Shops")),
    "Market Bazaar Item 3":                                 ("Shop",        0x2C,  0x32, (shop_address(4, 2), None), ("the Market", "Castle Town", "Shops")),
    "Market Bazaar Item 4":                                 ("Shop",        0x2C,  0x33, (shop_address(4, 3), None), ("the Market", "Castle Town", "Shops")),
    "Market Bazaar Item 5":                                 ("Shop",        0x2C,  0x34, (shop_address(4, 4), None), ("the Market", "Castle Town", "Shops")),
    "Market Bazaar Item 6":                                 ("Shop",        0x2C,  0x35, (shop_address(4, 5), None), ("the Market", "Castle Town", "Shops")),
    "Market Bazaar Item 7":                                 ("Shop",        0x2C,  0x36, (shop_address(4, 6), None), ("the Market", "Castle Town", "Shops")),
    "Market Bazaar Item 8":                                 ("Shop",        0x2C,  0x37, (shop_address(4, 7), None), ("the Market", "Castle Town", "Shops")),
    ...
    "LW Deku Scrub Near Forest Stage Right":        ("NPC",         0x5B,  0x30, None,                     ("the Lost Woods", "Forest", "Deku Scrub")),
    "LW Deku Scrub Near Forest Stage Left":         ("NPC",         0x5B,  0x31, None,                     ("the Lost Woods", "Forest", "Deku Scrub")),
    ...
    "KF Links House Cow":                                 ("NPC",         0x34,  0x15, None,                     ("Links House", "Forest", "Cow", "Minigames")),
