...
location_table = {
    "Kokiri Forest Chest":                              ("Chest",       0x55,  0x00, None,                     ("Kokiri Forest", "Forest",)),
    "Kokiri Forest Mido Chest Top Left":                             ("Chest",       0x28,  0x00, None,                     ("Kokiri Forest", "Forest",)),
    "Kokiri Forest Mido Chest Top Right":                            ("Chest",       0x28,  0x01, None,                     ("Kokiri Forest", "Forest",)),
    "Kokiri Forest Mido Chest Bottom Left":                          ("Chest",       0x28,  0x02, None,                     ("Kokiri Forest", "Forest",)),
    "Kokiri Forest Mido Chest Bottom Right":                         ("Chest",       0x28,  0x03, None,                     ("Kokiri Forest", "Forest",)),
    ...
    "Death Mountain Trail Chest":                   ("Chest",       0x60,  0x01, None,                     ("Death Mountain Trail", "Death Mountain",)),
    "Goron City Maze Left Chest":                  ("Chest",       0x62,  0x00, None,                     ("Goron City",)),
    "Goron City Maze Right Chest":                     ("Chest",       0x62,  0x01, None,                     ("Goron City",)),
    "Goron City Maze Center Chest":                      ("Chest",       0x62,  0x02, None,                     ("Goron City",)),
    "Zoras Domain Chest":                          ("Chest",       0x58,  0x00, None,                     ("Zora's Domain", )),
    "Graveyard Dampe Race Chest":                                  ("Chest",       0x48,  0x00, None,                     ("the Graveyard", "Kakariko",)),
    "Gerudo Valley Chest":                ("Chest",       0x5A,  0x00, None,                     ("Gerudo Valley", "Gerudo",)),
    "Gerudo Fortress Chest":                   ("Chest",       0x5D,  0x00, None,                     ("Gerudo's Fortress", "Gerudo",)),
    "Haunted Wasteland Chest":               ("Chest",       0x5E,  0x00, None,                     ("Haunted Wasteland",)),
    "Kakariko Village Redead Grotto Chest":                             ("Chest",       0x3E,  0x0A, None,                     ("Kakariko Village", "Kakariko", "Grottos")),
    "Sacred Forest Meadow Wolfos Grotto Chest":                             ("Chest",       0x3E,  0x11, None,                     ("Sacred Forest Meadow", "Forest", "Grottos")),
    "Hyrule Field Near Market Grotto Chest":             ("Chest",       0x3E,  0x00, None,                     ("Hyrule Field", "Grottos",)),
    "Hyrule Field Southeast Grotto Chest":                    ("Chest",       0x3E,  0x02, None,                     ("Hyrule Field", "Grottos",)),
    "Hyrule Field Open Grotto Chest":      ("Chest",       0x3E,  0x03, None,                     ("Hyrule Field", "Grottos",)),
    "Kakariko Village Open Grotto Chest":                      ("Chest",       0x3E,  0x08, None,                     ("Kakariko Village", "Kakariko", "Grottos")),
    ...
    "Lost Woods Grotto Chest":                 ("Chest",       0x3E,  0x14, None,                     ("the Lost Woods", "Forest", "Grottos")),
    "Death Mountain Trail Storms Grotto Chest":                    ("Chest",       0x3E,  0x17, None,                     ("Death Mountain Trail", "Death Mountain", "Grottos")),
    "Death Mountain Crater Grotto Chest":                      ("Chest",       0x3E,  0x1A, None,                     ("Death Mountain Crater", "Death Mountain", "Grottos")),
    "Market Treasure Chest Game":                             ("Chest",       0x10,  0x0A, None,                     ("the Market", "Castle Town", "Minigames")),

    "Temple of Time Light Arrows Cutscene":                                           ("Cutscene",    0xFF,  0x01, None,                     ("Temple of Time", "Castle Town",)),
    "Lost Woods Fairy Ocarina Cutscene":                                 ("Cutscene",    0xFF,  0x02, None,                     ("the Lost Woods", "Forest",)),
    "Zoras Fountain Great Fairy":                     ("Cutscene",    0xFF,  0x10, None,                     ("Zora's Fountain", "Fairies",)),
    "Hyrule Castle Great Fairy":                      ("Cutscene",    0xFF,  0x11, None,                     ("Hyrule Castle", "Castle Town", "Fairies")),
    "Desert Colossus Great Fairy":                    ("Cutscene",    0xFF,  0x12, None,                     ("Desert Colossus", "Fairies",)),
    "Death Mountain Trail Great Fairy":                    ("Cutscene",    0xFF,  0x13, None,                     ("Death Mountain Trail", "Death Mountain", "Fairies")),
    "Death Mountain Crater Great Fairy":                             ("Cutscene",    0xFF,  0x14, None,                     ("Death Mountain Crater", "Death Mountain", "Fairies",)),
    "Outside Ganons Castle Great Fairy":                      ("Cutscene",    0xFF,  0x15, None,                     ("outside Ganon's Castle", "Castle Town", "Fairies")),
    ...
    "Song from Impa":                                  ("Song",        0xFF,  0x26, (0x2E8E925, 0x2E8E925),   ("Hyrule Castle", "Castle Town", "Songs")),
    ...
    "Hyrule Castle Malon Egg":                                       ("NPC",         0x5F,  0x47, None,                     ("Hyrule Castle", "Castle Town",)),
    "Hyrule Castle Zeldas Letter":                                   ("NPC",         None,  None, None,                     ("Hyrule Castle", "Castle Town",)),
    "Goron City Darunias Joy":                                    ("NPC",         0x62,  0x54, None,                     ("Goron City",)),
    "Zoras Domain Diving Minigame":                                 ("NPC",         0x58,  0x37, None,                     ("Zora's Domain", "Minigames",)),
    "Lake Hylia Child Fishing":                                   ("NPC",         0x49,  0x3E, None,                     ("Lake Hylia", "Minigames",)),
    "Lake Hylia Adult Fishing":                                   ("NPC",         0x49,  0x38, None,                     ("Lake Hylia", "Minigames",)),
    "Lake Hylia Lab Dive":                               ("NPC",         0x38,  0x3E, None,                     ("Lake Hylia",)),
    "Goron City Adult Rolling Goron":                                  ("NPC",         0x62,  0x2C, None,                     ("Goron City",)),
    "Zoras Domain King Zora Thawed":                                ("NPC",         0x58,  0x2D, None,                     ("Zora's Domain",)),
    "Market Bombchu Bowling First Prize":                        ("NPC",         0x4B,  0x34, None,                     ("the Market", "Castle Town", "Minigames")),
    "Market Bombchu Bowling Second Prize":                  ("NPC",         0x4B,  0x3E, None,                     ("the Market", "Castle Town", "Minigames")),
    "Market Bombchu Bowling Bombchus":                        ("NPC",         0x4B,  None, None,                     ("the Market", "Castle Town", "Minigames")),
    "Market Dog Lady":                                        ("NPC",         0x35,  0x3E, None,                     ("the Market", "Castle Town",)),
    "Lost Woods Skull Kid":                                       ("NPC",         0x5B,  0x3E, None,                     ("the Lost Woods", "Forest",)),
    "Lost Woods Ocarina Memory Game":                             ("NPC",         0x5B,  0x76, None,                     ("the Lost Woods", "Forest", "Minigames")),
    "Kakariko Village 10 Gold Skulltula Reward":                        ("NPC",         0x50,  0x45, None,                     ("Kakariko Village", "Kakariko", "Skulltula House")),
    "Kakariko Village 20 Gold Skulltula Reward":                        ("NPC",         0x50,  0x39, None,                     ("Kakariko Village", "Kakariko", "Skulltula House")),
    "Kakariko Village 30 Gold Skulltula Reward":                        ("NPC",         0x50,  0x46, None,                     ("Kakariko Village", "Kakariko", "Skulltula House")),
    "Kakariko Village 40 Gold Skulltula Reward":                        ("NPC",         0x50,  0x03, None,                     ("Kakariko Village", "Kakariko", "Skulltula House")),
    "Kakariko Village 50 Gold Skulltula Reward":                        ("NPC",         0x50,  0x3E, None,                     ("Kakariko Village", "Kakariko", "Skulltula House")),
    "Kakariko Village Man on Roof":                                     ("NPC",         0x52,  0x3E, None,                     ("Kakariko Village", "Kakariko",)),
    "Zora River Magic Bean Salesman":                             ("NPC",         0x54,  0x16, None,                     ("Zora's River",)),
    "Zora River Frogs Ocarina Game":                               ("NPC",         0x54,  0x76, None,                     ("Zora's River",)),
    "Zora River Frogs in the Rain":                               ("NPC",         0x54,  0x3E, None,                     ("Zora's River", "Minigames",)),
    "Gerudo Fortress Horseback Archery 1000 Points":                   ("NPC",         0x5D,  0x3E, None,                     ("Gerudo's Fortress", "Gerudo", "Minigames")),
    "Gerudo Fortress Horseback Archery 1500 Points":                   ("NPC",         0x5D,  0x30, None,                     ("Gerudo's Fortress", "Gerudo", "Minigames")),
    "Market Child Shooting Gallery":                          ("NPC",         0x42,  0x60, None,                     ("the Market", "Castle Town", "Minigames")),
    "Kakariko Village Adult Shooting Gallery":                          ("NPC",         0x42,  0x30, None,                     ("Kakariko Village", "Kakariko", "Minigames")),
    "Lost Woods Target in Woods":                                 ("NPC",         0x5B,  0x60, None,                     ("the Lost Woods", "Forest",)),
    ...
    "Kakariko Village Anju as Adult":                                   ("NPC",         0x52,  0x1D, None,                     ("Kakariko Village", "Kakariko",)),
    "Death Mountain Trail Biggoron":                                        ("NPC",         0x60,  0x57, None,                     ("Death Mountain Trail", "Death Mountain",)),
    "Kakariko Village Anjus Chickens":                                  ("NPC",         0x52,  0x0F, None,                     ("Kakariko Village", "Kakariko", "Minigames")),
    "Lon Lon Ranch Talons Chickens":                                 ("NPC",         0x4C,  0x14, None,                     ("Lon Lon Ranch", "Kakariko", "Minigames")),
    "Market 10 Big Poes":                                     ("NPC",         0x4D,  0x0F, None,                     ("the Market", "Hyrule Castle",)),
    "Goron City Child Rolling Goron":                          ("NPC",         0x62,  0x34, None,                     ("Goron City",)),
    "Lake Hylia Underwater Bottle":                               ("NPC",         0x57,  0x15, None,                     ("Lake Hylia",)),
    "Lake Hylia Sun":                                  ("NPC",         0x57,  0x58, None,                     ("Lake Hylia",)),
    "Gerudo Fortress Membership Card":                 ("NPC",         0x0C,  0x3A, None,                     ("Gerudo's Fortress", "Gerudo",)),
    "Hyrule Field Ocarina of Time Item":                                 ("NPC",         0x51,  0x0C, None,                     ("Hyrule Field", "Need Spiritual Stones",)),
    "Haunted Wasteland Bombchu Salesman":              ("NPC",         None,  None, None,                     ("Haunted Wasteland",)),

    "Kakariko Village Impa House Freestanding PoH":                     ("Collectable", 0x37,  0x01, None,                     ("Kakariko Village", "Kakariko",)),
    "Hyrule Field Tektite Grotto Freestanding PoH":                 ("Collectable", 0x3E,  0x01, None,                     ("Hyrule Field", "Grottos",)),
    "Kakariko Village Windmill Freestanding PoH":                       ("Collectable", 0x48,  0x01, None,                     ("Kakariko Village", "Kakariko",)),
    "Graveyard Dampe Race Freestanding PoH":                     ("Collectable", 0x48,  0x07, None,                     ("the Graveyard", "Kakariko", "Minigames")),
    "Lon Lon Ranch Freestanding PoH":                  ("Collectable", 0x4C,  0x01, None,                     ("Lon Lon Ranch",)),
    ...
    "Desert Colossus Freestanding PoH":                       ("Collectable", 0x5C,  0x0D, None,                     ("Desert Colossus",)),
    "Death Mountain Trail Freestanding PoH":                       ("Collectable", 0x60,  0x1E, None,                     ("Death Mountain Trail", "Death Mountain",)),
    "Death Mountain Crater Wall Freestanding PoH":                 ("Collectable", 0x61,  0x02, None,                     ("Death Mountain Crater", "Death Mountain",)),
    "Death Mountain Crater Volcano Freestanding PoH":              ("Collectable", 0x61,  0x08, None,                     ("Death Mountain Crater", "Death Mountain",)),
    ...
    "Forest Temple Entry Chest":                       ("Chest",       0x03,  0x03, None,                     ("Forest Temple",)),
    ...
    "Forest Temple East Courtyard Chest":            ("Chest",       0x03,  0x05, None,                     ("Forest Temple",)),
    ...
    # Forest Temple MQ
    "Forest Temple MQ Entry Chest":                    ("Chest",       0x03,  0x03, None,                     ("Forest Temple",)),
    ...
    "Forest Temple MQ East Courtyard Lower Chest":        ("Chest",       0x03,  0x01, None,                     ("Forest Temple",)),
    "Forest Temple MQ East Courtyard Upper Chest":        ("Chest",       0x03,  0x05, None,                     ("Forest Temple",)),
    ...
    "Fire Temple Big Lava Room South Goron":        ("Chest",       0x04,  0x02, None,                     ("Fire Temple",)),
    "Fire Temple Big Lava Room North Goron":            ("Chest",       0x04,  0x04, None,                     ("Fire Temple",)),
    ...
    "Fire Temple MQ Big Lava Room South Goron":     ("Chest",       0x04,  0x01, None,                     ("Fire Temple",)),
    ...
    "Dodongos Cavern GS East Side Room":              ("GS Token",    0x01,  0x10, None,                     ("Dodongo's Cavern", "Skulltulas",)),
    ...
    "Forest Temple GS East Courtyard":                   ("GS Token",    0x03,  0x01, None,                     ("Forest Temple", "Skulltulas",)),
    "Forest Temple GS First Room":                     ("GS Token",    0x03,  0x02, None,                     ("Forest Temple", "Skulltulas",)),
    "Forest Temple GS West Courtyard":                   ("GS Token",    0x03,  0x04, None,                     ("Forest Temple", "Skulltulas",)),
    ...
    "Forest Temple MQ GS East Courtyard":                ("GS Token",    0x03,  0x01, None,                     ("Forest Temple", "Skulltulas",)),
    "Forest Temple MQ GS West Courtyard":                ("GS Token",    0x03,  0x04, None,                     ("Forest Temple", "Skulltulas",)),
    ...
    "Fire Temple MQ GS Big Lava Room North Goron":                 ("GS Token",    0x04,  0x01, None,                     ("Fire Temple", "Skulltulas",)),
    "Fire Temple MQ GS Fire Wall Maze Side Room":      ("GS Token",    0x04,  0x10, None,                     ("Fire Temple", "Skulltulas",)),
    "Fire Temple MQ GS East Tower Top":                ("GS Token",    0x04,  0x04, None,                     ("Fire Temple", "Skulltulas",)),
    "Water Temple GS South Basement":                  ("GS Token",    0x05,  0x01, None,                     ("Water Temple", "Skulltulas",)),
    ...
    "Water Temple MQ GS North Basement":               ("GS Token",    0x05,  0x08, None,                     ("Water Temple", "Skulltulas",)),
    ...
    "Water Temple MQ GS South Basement":               ("GS Token",    0x05,  0x10, None,                     ("Water Temple", "Skulltulas",)),
    "Spirit Temple GS Hall to West Iron Knuckle":      ("GS Token",    0x06,  0x01, None,                     ("Spirit Temple", "Skulltulas",)),
    ...
    "Hyrule Field GS Cow Grotto":              ("GS Token",    0x0A,  0x01, None,                     ("Hyrule Field", "Skulltulas", "Grottos")),
    "Hyrule Field GS Grotto Near Kakariko Village":                   ("GS Token",    0x0A,  0x02, None,                     ("Hyrule Field", "Skulltulas", "Grottos")),
    "Lon Lon Ranch GS Back Wall":                      ("GS Token",    0x0B,  0x01, None,                     ("Lon Lon Ranch", "Skulltulas",)),
    "Lon Lon Ranch GS Rain Shed":                      ("GS Token",    0x0B,  0x02, None,                     ("Lon Lon Ranch", "Skulltulas",)),
    "Lon Lon Ranch GS House Window":                   ("GS Token",    0x0B,  0x04, None,                     ("Lon Lon Ranch", "Skulltulas",)),
    "Lon Lon Ranch GS Tree":                           ("GS Token",    0x0B,  0x08, None,                     ("Lon Lon Ranch", "Skulltulas",)),
    "Kokiri Forest GS Bean Patch":                            ("GS Token",    0x0C,  0x01, None,                     ("Kokiri Forest", "Skulltulas",)),
    "Kokiri Forest GS Know It All House":                     ("GS Token",    0x0C,  0x02, None,                     ("Kokiri Forest", "Skulltulas",)),
    "Kokiri Forest GS House of Twins":                        ("GS Token",    0x0C,  0x04, None,                     ("Kokiri Forest", "Skulltulas",)),
    "Lost Woods GS Bean Patch Near Bridge":            ("GS Token",    0x0D,  0x01, None,                     ("the Lost Woods", "Skulltulas",)),
    "Lost Woods GS Bean Patch Near Stage":             ("GS Token",    0x0D,  0x02, None,                     ("the Lost Woods", "Skulltulas",)),
    "Lost Woods GS Above Stage":                       ("GS Token",    0x0D,  0x04, None,                     ("the Lost Woods", "Skulltulas",)),
    "Sacred Forest Meadow GS":                         ("GS Token",    0x0D,  0x08, None,                     ("Sacred Forest Meadow", "Skulltulas",)),
    "Outside Ganons Castle GS":                       ("GS Token",    0x0E,  0x01, None,                     ("outside Ganon's Castle", "Skulltulas",)),
    "Hyrule Castle GS Grotto":                         ("GS Token",    0x0E,  0x02, None,                     ("Hyrule Castle", "Skulltulas", "Grottos")),
    "Hyrule Castle GS Tree":                           ("GS Token",    0x0E,  0x04, None,                     ("Hyrule Castle", "Skulltulas",)),
    "Market GS Guard House":                    ("GS Token",    0x0E,  0x08, None,                     ("the Market", "Skulltulas",)),
    "Death Mountain Crater GS Bean Patch":                   ("GS Token",    0x0F,  0x01, None,                     ("Death Mountain Crater", "Skulltulas",)),
    "Death Mountain Trail GS Bean Patch":                    ("GS Token",    0x0F,  0x02, None,                     ("Death Mountain Trail", "Skulltulas",)),
    "Death Mountain Trail GS Near Kakariko Village":                   ("GS Token",    0x0F,  0x04, None,                     ("Death Mountain Trail", "Skulltulas",)),
    "Death Mountain Trail GS Above Dodongos Cavern":        ("GS Token",    0x0F,  0x08, None,                     ("Death Mountain Trail", "Skulltulas",)),
    "Death Mountain Trail GS Falling Rocks Path":                ("GS Token",    0x0F,  0x10, None,                     ("Death Mountain Trail", "Skulltulas",)),
    "Goron City GS Center Platform":                   ("GS Token",    0x0F,  0x20, None,                     ("Goron City", "Skulltulas",)),
    "Goron City GS Boulder Maze":                      ("GS Token",    0x0F,  0x40, None,                     ("Goron City", "Skulltulas",)),
    "Death Mountain Crater GS Crate":                  ("GS Token",    0x0F,  0x80, None,                     ("Death Mountain Crater", "Skulltulas",)),
    "Kakariko Village GS House Under Construction":            ("GS Token",    0x10,  0x08, None,                     ("Kakariko Village", "Skulltulas",)),
    "Kakariko Village GS Skulltula House":                     ("GS Token",    0x10,  0x10, None,                     ("Kakariko Village", "Skulltulas",)),
    "Kakariko Village GS Guards House":                       ("GS Token",    0x10,  0x02, None,                     ("Kakariko Village", "Skulltulas",)),
    "Kakariko Village GS Tree":                                ("GS Token",    0x10,  0x20, None,                     ("Kakariko Village", "Skulltulas",)),
    "Kakariko Village GS Watchtower":                          ("GS Token",    0x10,  0x04, None,                     ("Kakariko Village", "Skulltulas",)),
    "Kakariko Village GS Above Impas House":                  ("GS Token",    0x10,  0x40, None,                     ("Kakariko Village", "Skulltulas",)),
    ...
    "Zora River GS Ladder":                            ("GS Token",    0x11,  0x01, None,                     ("Zora's River", "Skulltulas",)),
    "Zora River GS Tree":                              ("GS Token",    0x11,  0x02, None,                     ("Zora's River", "Skulltulas",)),
    "Zoras Fountain GS Above the Log":                ("GS Token",    0x11,  0x04, None,                     ("Zora's Fountain", "Skulltulas",)),
    "Zora River GS Above Bridge":                      ("GS Token",    0x11,  0x08, None,                     ("Zora's River", "Skulltulas",)),
    "Zora River GS Near Raised Grottos":               ("GS Token",    0x11,  0x10, None,                     ("Zora's River", "Skulltulas",)),
    "Zoras Fountain GS Hidden Cave":                  ("GS Token",    0x11,  0x20, None,                     ("Zora's Fountain", "Skulltulas",)),
    "Zoras Domain GS Frozen Waterfall":               ("GS Token",    0x11,  0x40, None,                     ("Zora's Domain", "Skulltulas",)),
    "Zoras Fountain GS Tree":                         ("GS Token",    0x11,  0x80, None,                     ("Zora's Fountain", "Skulltulas",)),
    "Lake Hylia GS Bean Patch":                        ("GS Token",    0x12,  0x01, None,                     ("Lake Hylia", "Skulltulas",)),
    "Lake Hylia GS Small Island":                      ("GS Token",    0x12,  0x02, None,                     ("Lake Hylia", "Skulltulas",)),
    "Lake Hylia GS Lab Wall":                          ("GS Token",    0x12,  0x04, None,                     ("Lake Hylia", "Skulltulas",)),
    "Lake Hylia GS Lab Crate":                         ("GS Token",    0x12,  0x08, None,                     ("Lake Hylia", "Skulltulas",)),
    "Lake Hylia GS Tree":                        ("GS Token",    0x12,  0x10, None,                     ("Lake Hylia", "Skulltulas",)),
    "Gerudo Valley GS Bean Patch":                     ("GS Token",    0x13,  0x01, None,                     ("Gerudo Valley", "Skulltulas",)),
    "Gerudo Valley GS Small Bridge":                   ("GS Token",    0x13,  0x02, None,                     ("Gerudo Valley", "Skulltulas",)),
    "Gerudo Valley GS Pillar":                         ("GS Token",    0x13,  0x04, None,                     ("Gerudo Valley", "Skulltulas",)),
    "Gerudo Valley GS Behind Tent":                    ("GS Token",    0x13,  0x08, None,                     ("Gerudo Valley", "Skulltulas",)),
    "Gerudo Fortress GS Archery Range":                ("GS Token",    0x14,  0x01, None,                     ("Gerudo's Fortress", "Skulltulas",)),
    "Gerudo Fortress GS Top Floor":                    ("GS Token",    0x14,  0x02, None,                     ("Gerudo's Fortress", "Skulltulas",)),
    "Desert Colossus GS Bean Patch":                   ("GS Token",    0x15,  0x01, None,                     ("Desert Colossus", "Skulltulas",)),
    "Haunted Wasteland GS":                              ("GS Token",    0x15,  0x02, None,                     ("Haunted Wasteland", "Skulltulas",)),
    "Desert Colossus GS Hill":                         ("GS Token",    0x15,  0x04, None,                     ("Desert Colossus", "Skulltulas",)),
    "Desert Colossus GS Tree":                         ("GS Token",    0x15,  0x08, None,                     ("Desert Colossus", "Skulltulas",)),

    "Kokiri Forest Shop Item 7":                              ("Shop",        0x2D,  0x30, (shop_address(0, 0), None), ("Kokiri Forest", "Forest", "Shops")),
    "Kokiri Forest Shop Item 5":                              ("Shop",        0x2D,  0x31, (shop_address(0, 1), None), ("Kokiri Forest", "Forest", "Shops")),
    "Kokiri Forest Shop Item 8":                              ("Shop",        0x2D,  0x32, (shop_address(0, 2), None), ("Kokiri Forest", "Forest", "Shops")),
    "Kokiri Forest Shop Item 6":                              ("Shop",        0x2D,  0x33, (shop_address(0, 3), None), ("Kokiri Forest", "Forest", "Shops")),
    "Kokiri Forest Shop Item 4":                              ("Shop",        0x2D,  0x34, (shop_address(0, 4), None), ("Kokiri Forest", "Forest", "Shops")),
    "Kokiri Forest Shop Item 2":                              ("Shop",        0x2D,  0x35, (shop_address(0, 5), None), ("Kokiri Forest", "Forest", "Shops")),
    "Kokiri Forest Shop Item 3":                              ("Shop",        0x2D,  0x36, (shop_address(0, 6), None), ("Kokiri Forest", "Forest", "Shops")),
    "Kokiri Forest Shop Item 1":                              ("Shop",        0x2D,  0x37, (shop_address(0, 7), None), ("Kokiri Forest", "Forest", "Shops")),
    "Kakariko Village Potion Shop Item 7":                     ("Shop",        0x30,  0x30, (shop_address(1, 0), None), ("Kakariko Village", "Kakariko", "Shops")),
    "Kakariko Village Potion Shop Item 5":                     ("Shop",        0x30,  0x31, (shop_address(1, 1), None), ("Kakariko Village", "Kakariko", "Shops")),
    "Kakariko Village Potion Shop Item 8":                     ("Shop",        0x30,  0x32, (shop_address(1, 2), None), ("Kakariko Village", "Kakariko", "Shops")),
    "Kakariko Village Potion Shop Item 6":                     ("Shop",        0x30,  0x33, (shop_address(1, 3), None), ("Kakariko Village", "Kakariko", "Shops")),
    "Kakariko Village Potion Shop Item 4":                     ("Shop",        0x30,  0x34, (shop_address(1, 4), None), ("Kakariko Village", "Kakariko", "Shops")),
    "Kakariko Village Potion Shop Item 2":                     ("Shop",        0x30,  0x35, (shop_address(1, 5), None), ("Kakariko Village", "Kakariko", "Shops")),
    "Kakariko Village Potion Shop Item 3":                     ("Shop",        0x30,  0x36, (shop_address(1, 6), None), ("Kakariko Village", "Kakariko", "Shops")),
    "Kakariko Village Potion Shop Item 1":                     ("Shop",        0x30,  0x37, (shop_address(1, 7), None), ("Kakariko Village", "Kakariko", "Shops")),
    "Market Bombchu Shop Item 7":                             ("Shop",        0x32,  0x30, (shop_address(2, 0), None), ("the Market", "Castle Town", "Shops")),
    "Market Bombchu Shop Item 5":                             ("Shop",        0x32,  0x31, (shop_address(2, 1), None), ("the Market", "Castle Town", "Shops")),
    "Market Bombchu Shop Item 8":                             ("Shop",        0x32,  0x32, (shop_address(2, 2), None), ("the Market", "Castle Town", "Shops")),
    "Market Bombchu Shop Item 6":                             ("Shop",        0x32,  0x33, (shop_address(2, 3), None), ("the Market", "Castle Town", "Shops")),
    "Market Bombchu Shop Item 4":                             ("Shop",        0x32,  0x34, (shop_address(2, 4), None), ("the Market", "Castle Town", "Shops")),
    "Market Bombchu Shop Item 2":                             ("Shop",        0x32,  0x35, (shop_address(2, 5), None), ("the Market", "Castle Town", "Shops")),
    "Market Bombchu Shop Item 3":                             ("Shop",        0x32,  0x36, (shop_address(2, 6), None), ("the Market", "Castle Town", "Shops")),
    "Market Bombchu Shop Item 1":                             ("Shop",        0x32,  0x37, (shop_address(2, 7), None), ("the Market", "Castle Town", "Shops")),
    "Market Potion Shop Item 7":                  ("Shop",        0x31,  0x30, (shop_address(3, 0), None), ("the Market", "Castle Town", "Shops")),
    "Market Potion Shop Item 5":                  ("Shop",        0x31,  0x31, (shop_address(3, 1), None), ("the Market", "Castle Town", "Shops")),
    "Market Potion Shop Item 8":                  ("Shop",        0x31,  0x32, (shop_address(3, 2), None), ("the Market", "Castle Town", "Shops")),
    "Market Potion Shop Item 6":                  ("Shop",        0x31,  0x33, (shop_address(3, 3), None), ("the Market", "Castle Town", "Shops")),
    "Market Potion Shop Item 4":                  ("Shop",        0x31,  0x34, (shop_address(3, 4), None), ("the Market", "Castle Town", "Shops")),
    "Market Potion Shop Item 2":                  ("Shop",        0x31,  0x35, (shop_address(3, 5), None), ("the Market", "Castle Town", "Shops")),
    "Market Potion Shop Item 3":                  ("Shop",        0x31,  0x36, (shop_address(3, 6), None), ("the Market", "Castle Town", "Shops")),
    "Market Potion Shop Item 1":                  ("Shop",        0x31,  0x37, (shop_address(3, 7), None), ("the Market", "Castle Town", "Shops")),
    "Market Bazaar Item 7":                       ("Shop",        0x2C,  0x30, (shop_address(4, 0), None), ("the Market", "Castle Town", "Shops")),
    "Market Bazaar Item 5":                       ("Shop",        0x2C,  0x31, (shop_address(4, 1), None), ("the Market", "Castle Town", "Shops")),
    "Market Bazaar Item 8":                       ("Shop",        0x2C,  0x32, (shop_address(4, 2), None), ("the Market", "Castle Town", "Shops")),
    "Market Bazaar Item 6":                       ("Shop",        0x2C,  0x33, (shop_address(4, 3), None), ("the Market", "Castle Town", "Shops")),
    "Market Bazaar Item 4":                       ("Shop",        0x2C,  0x34, (shop_address(4, 4), None), ("the Market", "Castle Town", "Shops")),
    "Market Bazaar Item 2":                       ("Shop",        0x2C,  0x35, (shop_address(4, 5), None), ("the Market", "Castle Town", "Shops")),
    "Market Bazaar Item 3":                       ("Shop",        0x2C,  0x36, (shop_address(4, 6), None), ("the Market", "Castle Town", "Shops")),
    "Market Bazaar Item 1":                       ("Shop",        0x2C,  0x37, (shop_address(4, 7), None), ("the Market", "Castle Town", "Shops")),
    "Kakariko Village Bazaar Item 7":                          ("Shop",        0x2C,  0x38, (shop_address(5, 0), None), ("Kakariko Village", "Kakariko", "Shops")),
    "Kakariko Village Bazaar Item 5":                          ("Shop",        0x2C,  0x39, (shop_address(5, 1), None), ("Kakariko Village", "Kakariko", "Shops")),
    "Kakariko Village Bazaar Item 8":                          ("Shop",        0x2C,  0x3A, (shop_address(5, 2), None), ("Kakariko Village", "Kakariko", "Shops")),
    "Kakariko Village Bazaar Item 6":                          ("Shop",        0x2C,  0x3B, (shop_address(5, 3), None), ("Kakariko Village", "Kakariko", "Shops")),
    "Kakariko Village Bazaar Item 4":                          ("Shop",        0x2C,  0x3D, (shop_address(5, 4), None), ("Kakariko Village", "Kakariko", "Shops")),
    "Kakariko Village Bazaar Item 2":                          ("Shop",        0x2C,  0x3E, (shop_address(5, 5), None), ("Kakariko Village", "Kakariko", "Shops")),
    "Kakariko Village Bazaar Item 3":                          ("Shop",        0x2C,  0x3F, (shop_address(5, 6), None), ("Kakariko Village", "Kakariko", "Shops")),
    "Kakariko Village Bazaar Item 1":                          ("Shop",        0x2C,  0x40, (shop_address(5, 7), None), ("Kakariko Village", "Kakariko", "Shops")),
    "Zoras Domain Shop Item 7":                                ("Shop",        0x2F,  0x30, (shop_address(7, 0), None), ("Zora's Domain", "Shops",)),
    "Zoras Domain Shop Item 5":                                ("Shop",        0x2F,  0x31, (shop_address(7, 1), None), ("Zora's Domain", "Shops",)),
    "Zoras Domain Shop Item 8":                                ("Shop",        0x2F,  0x32, (shop_address(7, 2), None), ("Zora's Domain", "Shops",)),
    "Zoras Domain Shop Item 6":                                ("Shop",        0x2F,  0x33, (shop_address(7, 3), None), ("Zora's Domain", "Shops",)),
    "Zoras Domain Shop Item 4":                                ("Shop",        0x2F,  0x34, (shop_address(7, 4), None), ("Zora's Domain", "Shops",)),
    "Zoras Domain Shop Item 2":                                ("Shop",        0x2F,  0x35, (shop_address(7, 5), None), ("Zora's Domain", "Shops",)),
    "Zoras Domain Shop Item 3":                                ("Shop",        0x2F,  0x36, (shop_address(7, 6), None), ("Zora's Domain", "Shops",)),
    "Zoras Domain Shop Item 1":                                ("Shop",        0x2F,  0x37, (shop_address(7, 7), None), ("Zora's Domain", "Shops",)),
    "Goron City Shop Item 7":                               ("Shop",        0x2E,  0x30, (shop_address(8, 0), None), ("Goron City", "Shops",)),
    "Goron City Shop Item 5":                               ("Shop",        0x2E,  0x31, (shop_address(8, 1), None), ("Goron City", "Shops",)),
    "Goron City Shop Item 8":                               ("Shop",        0x2E,  0x32, (shop_address(8, 2), None), ("Goron City", "Shops",)),
    "Goron City Shop Item 6":                               ("Shop",        0x2E,  0x33, (shop_address(8, 3), None), ("Goron City", "Shops",)),
    "Goron City Shop Item 4":                               ("Shop",        0x2E,  0x34, (shop_address(8, 4), None), ("Goron City", "Shops",)),
    "Goron City Shop Item 2":                               ("Shop",        0x2E,  0x35, (shop_address(8, 5), None), ("Goron City", "Shops",)),
    "Goron City Shop Item 3":                               ("Shop",        0x2E,  0x36, (shop_address(8, 6), None), ("Goron City", "Shops",)),
    "Goron City Shop Item 1":                               ("Shop",        0x2E,  0x37, (shop_address(8, 7), None), ("Goron City", "Shops",)),
    ...
    "Dodongos Cavern Deku Scrub East Side Room":                       ("NPC",         0x01,  0x31, None,                     ("Dodongo's Cavern", "Deku Scrub",)),
    ...
    "Dodongos Cavern MQ Deku Scrub East Side Room":                     ("NPC",         0x01,  0x39, None,                     ("Dodongo's Cavern", "Deku Scrub",)),
    ...
    "Hyrule Field Grotto Deku Scrub":             ("GrottoNPC",   0xE6,  0x3E, None,                     ("Hyrule Field", "Deku Scrub", "Deku Scrub Upgrades", "Grottos")),
    "Zoras River Grotto Deku Scrub Rear":                 ("GrottoNPC",   0xEB,  0x39, None,                     ("Zora's River", "Deku Scrub", "Grottos")),
    "Zoras River Grotto Deku Scrub Front":               ("GrottoNPC",   0xEB,  0x3A, None,                     ("Zora's River", "Deku Scrub", "Grottos")),
    "Sacred Forest Meadow Grotto Deku Scrub Rear":                ("GrottoNPC",   0xEE,  0x39, None,                     ("Sacred Forest Meadow", "Forest", "Deku Scrub", "Grottos")),
    "Sacred Forest Meadow Grotto Deku Scrub Front":              ("GrottoNPC",   0xEE,  0x3A, None,                     ("Sacred Forest Meadow", "Forest", "Deku Scrub", "Grottos")),
    "Lake Hylia Grotto Deku Scrub Left":                  ("GrottoNPC",   0xEF,  0x30, None,                     ("Lake Hylia", "Deku Scrub", "Grottos")),
    "Lake Hylia Grotto Deku Scrub Right":                      ("GrottoNPC",   0xEF,  0x37, None,                     ("Lake Hylia", "Deku Scrub", "Grottos")),
    "Lake Hylia Grotto Deku Scrub Center":                     ("GrottoNPC",   0xEF,  0x33, None,                     ("Lake Hylia", "Deku Scrub", "Grottos")),
    "Gerudo Valley Grotto Deku Scrub Rear":             ("GrottoNPC",   0xF0,  0x39, None,                     ("Gerudo Valley", "Gerudo", "Deku Scrub", "Grottos")),
    "Gerudo Valley Grotto Deku Scrub Front":           ("GrottoNPC",   0xF0,  0x3A, None,                     ("Gerudo Valley", "Gerudo", "Deku Scrub", "Grottos")),
    "Lost Woods Deku Scrub Near Forest Stage Right":                         ("NPC",         0x5B,  0x30, None,                     ("the Lost Woods", "Forest", "Deku Scrub")),
    "Lost Woods Deku Scrub Near Forest Stage Left":                       ("NPC",         0x5B,  0x31, None,                     ("the Lost Woods", "Forest", "Deku Scrub")),
    "Lost Woods Deku Scrub Near Bridge":                ("NPC",         0x5B,  0x77, None,                     ("the Lost Woods", "Forest", "Deku Scrub", "Deku Scrub Upgrades")),
    "Lost Woods Grotto Deku Scrub Rear":                     ("GrottoNPC",   0xF5,  0x33, None,                     ("the Lost Woods", "Forest", "Deku Scrub", "Grottos")),
    "Lost Woods Grotto Deku Scrub Front":           ("GrottoNPC",   0xF5,  0x79, None,                     ("the Lost Woods", "Forest", "Deku Scrub", "Deku Scrub Upgrades", "Grottos")),
    "Desert Colossus Grotto Deku Scrub Rear":             ("GrottoNPC",   0xFD,  0x39, None,                     ("Desert Colossus", "Deku Scrub", "Grottos")),
    "Desert Colossus Grotto Deku Scrub Front":           ("GrottoNPC",   0xFD,  0x3A, None,                     ("Desert Colossus", "Deku Scrub", "Grottos")),
    "Death Mountain Crater Deku Scrub":                            ("NPC",         0x61,  0x37, None,                     ("Death Mountain Crater", "Death Mountain", "Deku Scrub")),
    "Death Mountain Crater Grotto Deku Scrub Left":                 ("GrottoNPC",   0xF9,  0x30, None,                     ("Death Mountain Crater", "Death Mountain", "Deku Scrub", "Grottos")),
    "Death Mountain Crater Grotto Deku Scrub Right":                     ("GrottoNPC",   0xF9,  0x37, None,                     ("Death Mountain Crater", "Death Mountain", "Deku Scrub", "Grottos")),
    "Death Mountain Crater Grotto Deku Scrub Center":                    ("GrottoNPC",   0xF9,  0x33, None,                     ("Death Mountain Crater", "Death Mountain", "Deku Scrub", "Grottos")),
    "Goron City Grotto Deku Scrub Left":               ("GrottoNPC",   0xFB,  0x30, None,                     ("Goron City", "Deku Scrub", "Grottos")),
    "Goron City Grotto Deku Scrub Right":                   ("GrottoNPC",   0xFB,  0x37, None,                     ("Goron City", "Deku Scrub", "Grottos")),
    "Goron City Grotto Deku Scrub Center":                  ("GrottoNPC",   0xFB,  0x33, None,                     ("Goron City", "Deku Scrub", "Grottos")),
    "Lon Lon Ranch Grotto Deku Scrub Left":                 ("GrottoNPC",   0xFC,  0x30, None,                     ("Lon Lon Ranch", "Deku Scrub", "Grottos")),
    "Lon Lon Ranch Grotto Deku Scrub Right":                     ("GrottoNPC",   0xFC,  0x37, None,                     ("Lon Lon Ranch", "Deku Scrub", "Grottos")),
    "Lon Lon Ranch Grotto Deku Scrub Center":                    ("GrottoNPC",   0xFC,  0x33, None,                     ("Lon Lon Ranch", "Deku Scrub", "Grottos")),

    "Lon Lon Ranch Stables Left Cow":                            ("NPC",         0x36,  0x15, None,                     ("Lon Lon Ranch", "Cow",)),
    "Lon Lon Ranch Stables Right Cow":                           ("NPC",         0x36,  0x16, None,                     ("Lon Lon Ranch", "Cow",)),
    "Lon Lon Ranch Tower Right Cow":                             ("NPC",         0x4C,  0x15, None,                     ("Lon Lon Ranch", "Cow",)),
    "Lon Lon Ranch Tower Left Cow":                              ("NPC",         0x4C,  0x16, None,                     ("Lon Lon Ranch", "Cow",)),
    "Kokiri Forest Links House Cow":                                 ("NPC",         0x34,  0x15, None,                     ("Links House", "Forest", "Cow", "Minigames")),
    "Kakariko Village Impas House Cow":                                 ("NPC",         0x37,  0x15, None,                     ("Kakariko Village", "Kakariko", "Cow")),
    "Gerudo Valley Cow":                               ("NPC",         0x5A,  0x15, None,                     ("Gerudo Valley", "Gerudo", "Cow")),
    "Death Mountain Trail Grotto Cow":                                  ("NPC",         0x3E,  0x15, None,                     ("Death Mountain Trail", "Death Mountain", "Cow", "Grottos")),
    "Hyrule Field Grotto Cow":                                   ("NPC",         0x3E,  0x16, None,                     ("Hyrule Field", "Cow", "Grottos")),
    ...
    "Hyrule Castle Grotto Gossip Stone":               ("GossipStone", None,  None, None,                     None),
    "Hyrule Field Cow Grotto Gossip Stone":                ("GossipStone", None,  None, None,                     None),
    ...
    "Hyrule Field Near Market Grotto Gossip Stone":      ("GossipStone", None,  None, None,                     None),
    "Hyrule Field Southeast Grotto Gossip Stone":             ("GossipStone", None,  None, None,                     None),
    "Hyrule Field Open Grotto Gossip Stone":("GossipStone",None,  None, None,                     None),
    "Kakariko Village Open Grotto Gossip Stone":               ("GossipStone", None,  None, None,                     None),
    ...
    "Lost Woods Grotto Gossip Stone":          ("GossipStone", None,  None, None,                     None),
    "Death Mountain Trail Storms Grotto Gossip Stone":             ("GossipStone", None,  None, None,                     None),
    "Death Mountain Crater Grotto Gossip Stone":               ("GossipStone", None,  None, None,                     None),
