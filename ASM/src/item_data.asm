...
Item_Row 0x4F, 0xFF, 0xE2, 0xE4, 0x00CD, magic_upgrade, give_magic,   -1, -1 ; 0xC0 = Progressive Magic Meter
Item_Row 0x4F, 0xFF, 0xE1, 0xE8, 0x00CD, no_upgrade,    double_magic, -1, -1 ; 0xC1 = Double Magic
