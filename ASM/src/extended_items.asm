...
Item_Row 0x53, 0x41, 0x0B, 0x85, 0x00B8, no_upgrade, give_dungeon_item, 0x02, BOTW_ID    ; 0xA0 = Bottom of the Well Compass
...
Item_Row 0x53, 0x41, 0x1C, 0x90, 0x00C8, no_upgrade, give_dungeon_item, 0x04, SHADOW_ID  ; 0xA9 = Shadow Temple Map
Item_Row 0x53, 0x41, 0x1C, 0x91, 0x00C8, no_upgrade, give_dungeon_item, 0x04, BOTW_ID    ; 0xAA = Bottom of the Well Map
Item_Row 0x53, 0x41, 0x1C, 0x92, 0x00C8, no_upgrade, give_dungeon_item, 0x04, ICE_ID     ; 0xAB = Ice Cavern Map

Item_Row 0x53, 0x41, 0xFE, 0x93, 0x00AA, no_upgrade, give_small_key, FOREST_ID, -1 ; 0xAC = Forest Temple Small Key
Item_Row 0x53, 0x41, 0xFE, 0x94, 0x00AA, no_upgrade, give_small_key, FIRE_ID,   -1 ; 0xAD = Fire Temple Small Key
Item_Row 0x53, 0x41, 0xFE, 0x95, 0x00AA, no_upgrade, give_small_key, WATER_ID,  -1 ; 0xAE = Water Temple Small Key
Item_Row 0x53, 0x41, 0xFE, 0x97, 0x00AA, no_upgrade, give_small_key, SPIRIT_ID, -1 ; 0xAF = Spirit Temple Small Key
Item_Row 0x53, 0x41, 0xFE, 0x99, 0x00AA, no_upgrade, give_small_key, SHADOW_ID, -1 ; 0xB0 = Shadow Temple Small Key
Item_Row 0x53, 0x41, 0xFE, 0x9B, 0x00AA, no_upgrade, give_small_key, BOTW_ID,   -1 ; 0xB1 = Bottom of the Well Small Key
Item_Row 0x53, 0x41, 0xFE, 0x9F, 0x00AA, no_upgrade, give_small_key, GTG_ID,    -1 ; 0xB2 = Gerudo Training Small Key
Item_Row 0x53, 0x41, 0xFE, 0xA0, 0x00AA, no_upgrade, give_small_key, FORT_ID,   -1 ; 0xB3 = Gerudo Fortress Small Key
Item_Row 0x53, 0x41, 0xFE, 0xA1, 0x00AA, no_upgrade, give_small_key, CASTLE_ID, -1 ; 0xB4 = Ganon's Castle Small Key
