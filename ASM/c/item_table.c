...
item_row_t item_table[] = {
    ...
    [0x1D] = ITEM_ROW(0x53, 0, 0x2D, 0x0001, 0x00DA, 0x29, no_upgrade, no_effect, -1, -1), // Pocket Egg
    ...
    [0x7C] = ITEM_ROW(0x7C, 0, 0xFF, 0x0000, 0x0000, 0x00, no_upgrade, no_effect, -1, -1), // Ice Trap
