...
item_row_t item_table[] = {
    ...
    [0x7C] = ITEM_ROW(0x7C, 0, 0xFF, 0x00C8, 0x0158, 0x61, no_upgrade, no_effect, -1, -1), // Ice Trap Get item
    [0x7D] = ITEM_ROW(0x7C, 0, 0x41, 0x0000, 0x0158, 0x61, no_upgrade, no_effect, -1, -1), // Ice Trap
