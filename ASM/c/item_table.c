...
item_row_t item_table[] = {
    [0x01] = ITEM_ROW(0x01, 0x8E, 0x32, 0x00CE, 0xE0, no_upgrade, no_effect, -1, -1), // Bombs (5)
    ...
    [0x3C] = ITEM_ROW(0x3C, 0x58, 0xDC, 0x0119, 0xB8, no_upgrade, no_effect, -1, -1), // Deku Seeds (5)
    ...
    [0x49] = ITEM_ROW(0x49, 0x92, 0xE6, 0x00D8, 0xDB, no_upgrade, no_effect, -1, -1), // Arrows (5)
    [0x4A] = ITEM_ROW(0x4A, 0x93, 0xE6, 0x00D8, 0xDA, no_upgrade, no_effect, -1, -1), // Arrows (10)
    [0x4B] = ITEM_ROW(0x4B, 0x94, 0xE6, 0x00D8, 0xD9, no_upgrade, no_effect, -1, -1), // Arrows (30)
    ...
    [0x57] = ITEM_ROW(0x57, 0x3D, 0x0C, 0x00F8, 0x43, no_upgrade, no_effect, -1, -1), // Biggoron's Sword
    ...
    [0x65] = ITEM_ROW(0x65, 0x02, 0x32, 0x00CE, 0xE0, no_upgrade, no_effect, -1, -1), // Bomb
    [0x66] = ITEM_ROW(0x66, 0x8F, 0x32, 0x00CE, 0xE0, no_upgrade, no_effect, -1, -1), // Bombs (10)
    [0x67] = ITEM_ROW(0x67, 0x90, 0x32, 0x00CE, 0xE0, no_upgrade, no_effect, -1, -1), // Bombs (20)
    [0x68] = ITEM_ROW(0x68, 0x91, 0x32, 0x00CE, 0xE0, no_upgrade, no_effect, -1, -1), // Bombs (30)
    [0x69] = ITEM_ROW(0x69, 0x95, 0xDC, 0x0119, 0xB8, no_upgrade, no_effect, -1, -1), // Deku Seeds (30)
