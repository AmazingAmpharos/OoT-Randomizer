...
def patch_rom(spoiler:Spoiler, world:World, rom:Rom):
    ...
    if world.shuffle_overworld_entrances:
        ...
        write_entrance(0x0138, 0x0594) # After 1st Impa escort (overridden to Hyrule Castle entrance from Market)
        write_entrance(0x0138, 0x00CD) # After 2nd+ Impa escort (overridden to Hyrule Castle entrance from Market)
