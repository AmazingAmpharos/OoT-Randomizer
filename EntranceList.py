...
mandatory_connections = [
    ('Adult Forest Warp Pad', 'Forest Temple Entry Area'),
...
DT_MQ_connections = [
    ('Deku Tree Compass Passage', 'Deku Tree Compass Room'),
    ('Deku Tree Compass Exit', 'Deku Tree Lobby'),
    ('Deku Tree Basement Path', 'Deku Tree Boss Room'),
    ('Deku Tree Basement Vines', 'Deku Tree Lobby')
]

DC_vanilla_connections = [
...
JB_MQ_connections = [
    ('Jabu Jabus Belly Cow Switch', 'Jabu Jabus Belly Main'),
    ('Jabu Jabus Belly Retreat', 'Jabu Jabus Belly Beginning'),
...
FoT_MQ_connections = [
    ('Forest Temple Lobby Locked Door', 'Forest Temple Central Area'),
...
GTG_MQ_connections = [
    ('Gerudo Training Grounds Left Door', 'Gerudo Training Grounds Left Side'),
...
default_connections = [
    ('Links House Exit', 'Kokiri Forest'),
