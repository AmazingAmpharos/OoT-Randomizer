...
gossipLocations = {
    ...
    0x040D: GossipStone('ZR (Plateau)',                     'ZR Plateau Gossip Stone'),
    0x040C: GossipStone('ZR (Waterfall)',                   'ZR Waterfall Gossip Stone'),
    ...
    0x044A: GossipStone('DMC (Generic Grotto)',             'DMC Generic Grotto Gossip Stone'),
}
