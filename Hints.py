...
gossipLocations = {
    ...
    0x041A: GossipStone('Desert Colossus (Spirit Temple)',      'Colossus Gossip Stone'),
    0x0414: GossipStone('Dodongos Cavern (Bombable Wall)',      'Dodongos Cavern Gossip Stone'),
    0x0411: GossipStone('Gerudo Valley (Waterfall)',            'GV Gossip Stone'),
    ...
    0x0403: GossipStone('Lake Hylia (Lab)',                     'LH Lab Gossip Stone'),
    0x040F: GossipStone('Lake Hylia (Southeast Corner)',        'LH Gossip Stone (Southeast)'),
    0x0408: GossipStone('Lake Hylia (Southwest Corner)',        'LH Gossip Stone (Southwest)'),
    ...
    0x043C: GossipStone('Kokiri Forest (Storms Grotto)',        'KF Storms Grotto Gossip Stone'),
    0x0444: GossipStone('LW (Generic Grotto)',                  'LW Generic Grotto Gossip Stone'),
