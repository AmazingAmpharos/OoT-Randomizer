...
location_table = {
    ...
    'Sheik Forest Song': (0x20B0809, 0x20B0809, 0x20, 'Song', 0xFF, 'Sacred Forest Meadow'),
    'Sheik in Crater': (0x224D7F1, 0x224D7F1, 0x21, 'Song', 0xFF, 'Death Mountain Crater'),
    'Sheik in Ice Cavern': (0x2BEC889, 0x2BEC889, 0x22, 'Song', 0xFF, 'Ice Cavern'),
    'Sheik at Colossus': (0x218C57D, 0x218C57D, 0x23, 'Song', 0xFF, 'Desert Colossus'),
    'Sheik in Kakariko': (0x2000FE1, 0x2000FE1, 0x24, 'Song', 0xFF, 'Kakariko Village'),
    'Sheik at Temple': (0x2531329, 0x2531329, 0x25, 'Song', 0xFF, 'Temple of Time'),
    'Impa at Castle': (0x2E8E925, 0x2E8E925, 0x26, 'Song', 0xFF, 'Hyrule Castle'),
    'Song from Malon': (0xD7EB53, 0xD7EBCF, 0x27, 'Song', 0xFF, 'Lon Lon Ranch'),
    'Song from Saria': (0x20B1DB1, 0x20B1DB1, 0x28, 'Song', 0xFF, 'Sacred Forest Meadow'),
    'Song from Composer Grave': (0x332A871, 0x332A871, 0x29, 'Song', 0xFF, 'the Graveyard'),
    'Song from Ocarina of Time': (0x252FC89, 0x252FC89, 0x2A, 'Song', 0xFF, 'Hyrule Field'),
    'Song at Windmill': (0xE42C07, 0xE42B8B, 0x2B, 'Song', 0xFF, 'Kakariko Village'),
    'Gift from Saria': (None, None, 0x02, 'Cutscene', 0xFF, 'the Lost Woods'),
    'Malon Egg': (None, None, 0x47, 'NPC', 0x5F, 'Hyrule Castle'),
    'Zeldas Letter': (None, None, None, 'NPC', None, 'Hyrule Castle'),
    'Zelda': (0x3481400, None, 0x01, 'Cutscene', 0xFF, 'Temple of Time'),
    'Zoras Fountain Fairy Reward': (0x3481401, None, 0x10, 'Cutscene', 0xFF, 'Zora\'s Fountain'),
    'Hyrule Castle Fairy Reward': (0x3481402, None, 0x11, 'Cutscene', 0xFF, 'Hyrule Castle'),
    'Desert Colossus Fairy Reward': (0x3481403, None, 0x12, 'Cutscene', 0xFF, 'Desert Colossus'),
    'Mountain Summit Fairy Reward': (0x3481404, None, 0x13, 'Cutscene', 0xFF, 'Death Mountain Trail'),
    'Crater Fairy Reward': (0x3481405, None, 0x14, 'Cutscene', 0xFF, 'Death Mountain Crater'),
    'Ganons Castle Fairy Reward': (0x3481406, None, 0x15, 'Cutscene', 0xFF, 'outside Ganon\'s Castle'),
