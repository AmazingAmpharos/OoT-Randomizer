...
def create_regions(world):
    ...
    world.regions = [
        ...
        create_interior_region(
            'Castle Town Bazaar', 
            ['Bazaar Item 1', 'Bazaar Item 2', 'Bazaar Item 3', 'Bazaar Item 4', 
            'Bazaar Item 5', 'Bazaar Item 6', 'Bazaar Item 7', 'Bazaar Item 8']),
        ...
        create_interior_region('Kakariko Bazaar', None, ['Castle Town Bazaar']),
        ...
        create_ow_region(
            ...
            ['Goron City Exit', 'Goron City Bomb Wall', 'Darunias Chamber', 'Crater Access', 'Goron Shop']),
        create_ow_region(
...
location_table = {
    ...
    'Kokiri Shop Item 1': (0xC71ED0, None, 0x000D, 'Shop', None, 'Kokiri Forest'),
    'Kokiri Shop Item 2': (0xC71ED8, None, 0x0000, 'Shop', None, 'Kokiri Forest'),
    'Kokiri Shop Item 3': (0xC71EE0, None, 0x0004, 'Shop', None, 'Kokiri Forest'),
    'Kokiri Shop Item 4': (0xC71EE8, None, 0x0005, 'Shop', None, 'Kokiri Forest'),
    'Kokiri Shop Item 5': (0xC71EF0, None, 0x001D, 'Shop', None, 'Kokiri Forest'),
    'Kokiri Shop Item 6': (0xC71EF8, None, 0x002C, 'Shop', None, 'Kokiri Forest'),
    'Kokiri Shop Item 7': (0xC71F00, None, 0x0001, 'Shop', None, 'Kokiri Forest'),
    'Kokiri Shop Item 8': (0xC71F08, None, 0x0010, 'Shop', None, 'Kokiri Forest'),
    'Kakariko Potion Shop Item 1': (0xC71F10, None, 0x0009, 'Shop', None, 'Kakariko Village'),
    ...
    'Kakariko Potion Shop Item 6': (0xC71F38, None, 0x0028, 'Shop', None, 'Kakariko Village'),
    ...
    'Bombchu Shop Item 1': (0xC71F50, None, 0x0018, 'Shop', None, 'the market'),
    'Bombchu Shop Item 2': (0xC71F58, None, 0x001C, 'Shop', None, 'the market'),
    'Bombchu Shop Item 3': (0xC71F60, None, 0x0019, 'Shop', None, 'the market'),
    'Bombchu Shop Item 4': (0xC71F68, None, 0x0015, 'Shop', None, 'the market'),
    'Bombchu Shop Item 5': (0xC71F70, None, 0x001A, 'Shop', None, 'the market'),
    'Bombchu Shop Item 6': (0xC71F78, None, 0x0016, 'Shop', None, 'the market'),
    'Bombchu Shop Item 7': (0xC71F80, None, 0x001B, 'Shop', None, 'the market'),
    'Bombchu Shop Item 8': (0xC71F88, None, 0x0017, 'Shop', None, 'the market'),
    'Castle Town Potion Shop Item 1': (0xC71F90, None, 0x0009, 'Shop', None, 'the market'),
    'Castle Town Potion Shop Item 2': (0xC71F98, None, 0x0027, 'Shop', None, 'the market'),
    'Castle Town Potion Shop Item 3': (0xC71FA0, None, 0x0008, 'Shop', None, 'the market'),
    'Castle Town Potion Shop Item 4': (0xC71FA8, None, 0x002B, 'Shop', None, 'the market'),
    'Castle Town Potion Shop Item 5': (0xC71FB0, None, 0x0000, 'Shop', None, 'the market'),
    'Castle Town Potion Shop Item 6': (0xC71FB8, None, 0x0028, 'Shop', None, 'the market'),
    'Castle Town Potion Shop Item 7': (0xC71FC0, None, 0x002A, 'Shop', None, 'the market'),
    'Castle Town Potion Shop Item 8': (0xC71FC8, None, 0x0007, 'Shop', None, 'the market'),
    'Bazaar Item 1': (0xC71FD0, None, 0x000C, 'Shop', None, 'the market'),
    'Bazaar Item 2': (0xC71FD8, None, 0x002F, 'Shop', None, 'the market'),
    'Bazaar Item 3': (0xC71FE0, None, 0x0000, 'Shop', None, 'the market'),
    'Bazaar Item 4': (0xC71FE8, None, 0x0010, 'Shop', None, 'the market'),
    'Bazaar Item 5': (0xC71FF0, None, 0x002C, 'Shop', None, 'the market'),
    'Bazaar Item 6': (0xC71FF8, None, 0x0002, 'Shop', None, 'the market'),
    'Bazaar Item 7': (0xC72000, None, 0x0005, 'Shop', None, 'the market'),
    'Bazaar Item 8': (0xC72008, None, 0x0001, 'Shop', None, 'the market'),
    'Zora Shop Item 1': (0xC720D0, None, 0x000F, 'Shop', None, 'Zora\'s Domain'),
    'Zora Shop Item 2': (0xC720D8, None, 0x002C, 'Shop', None, 'Zora\'s Domain'),
    'Zora Shop Item 3': (0xC720E0, None, 0x0010, 'Shop', None, 'Zora\'s Domain'),
    'Zora Shop Item 4': (0xC720E8, None, 0x0001, 'Shop', None, 'Zora\'s Domain'),
    'Zora Shop Item 5': (0xC720F0, None, 0x0000, 'Shop', None, 'Zora\'s Domain'),
    'Zora Shop Item 6': (0xC720F8, None, 0x0002, 'Shop', None, 'Zora\'s Domain'),
    'Zora Shop Item 7': (0xC72100, None, 0x0007, 'Shop', None, 'Zora\'s Domain'),
    'Zora Shop Item 8': (0xC72108, None, 0x0031, 'Shop', None, 'Zora\'s Domain'),
    'Goron Shop Item 1': (0xC72110, None, 0x0003, 'Shop', None, 'Goron City'),
    'Goron Shop Item 2': (0xC72118, None, 0x0006, 'Shop', None, 'Goron City'),
    'Goron Shop Item 3': (0xC72120, None, 0x002D, 'Shop', None, 'Goron City'),
    'Goron Shop Item 4': (0xC72128, None, 0x002E, 'Shop', None, 'Goron City'),
    'Goron Shop Item 5': (0xC72130, None, 0x000E, 'Shop', None, 'Goron City'),
    'Goron Shop Item 6': (0xC72138, None, 0x0010, 'Shop', None, 'Goron City'),
    'Goron Shop Item 7': (0xC72140, None, 0x0030, 'Shop', None, 'Goron City'),
    'Goron Shop Item 8': (0xC72148, None, 0x0010, 'Shop', None, 'Goron City'),
}
