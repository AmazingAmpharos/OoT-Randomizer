...
location_table = {
    ...
    'Kokiri Shop Item 1': (0xC71ED0, None, 0x30, 'Shop', 0x2D, 'Kokiri Forest'),
    'Kokiri Shop Item 2': (0xC71ED8, None, 0x31, 'Shop', 0x2D, 'Kokiri Forest'),
    'Kokiri Shop Item 3': (0xC71EE0, None, 0x32, 'Shop', 0x2D, 'Kokiri Forest'),
    'Kokiri Shop Item 4': (0xC71EE8, None, 0x33, 'Shop', 0x2D, 'Kokiri Forest'),
    'Kokiri Shop Item 5': (0xC71EF0, None, 0x34, 'Shop', 0x2D, 'Kokiri Forest'),
    'Kokiri Shop Item 6': (0xC71EF8, None, 0x35, 'Shop', 0x2D, 'Kokiri Forest'),
    'Kokiri Shop Item 7': (0xC71F00, None, 0x36, 'Shop', 0x2D, 'Kokiri Forest'),
    'Kokiri Shop Item 8': (0xC71F08, None, 0x37, 'Shop', 0x2D, 'Kokiri Forest'),
    'Kakariko Potion Shop Item 1': (0xC71F10, None, 0x30, 'Shop', 0x30, 'Kakariko Village'),
    ...
    'Kakariko Potion Shop Item 6': (0xC71F38, None, 0x35, 'Shop', 0x30, 'Kakariko Village'),
    ...
    'Bombchu Shop Item 1': (0xC71F50, None, 0x30, 'Shop', 0x32, 'the market'),
    'Bombchu Shop Item 2': (0xC71F58, None, 0x31, 'Shop', 0x32, 'the market'),
    'Bombchu Shop Item 3': (0xC71F60, None, 0x32, 'Shop', 0x32, 'the market'),
    'Bombchu Shop Item 4': (0xC71F68, None, 0x33, 'Shop', 0x32, 'the market'),
    'Bombchu Shop Item 5': (0xC71F70, None, 0x34, 'Shop', 0x32, 'the market'),
    'Bombchu Shop Item 6': (0xC71F78, None, 0x35, 'Shop', 0x32, 'the market'),
    'Bombchu Shop Item 7': (0xC71F80, None, 0x36, 'Shop', 0x32, 'the market'),
    'Bombchu Shop Item 8': (0xC71F88, None, 0x37, 'Shop', 0x32, 'the market'),
    'Castle Town Potion Shop Item 1': (0xC71F90, None, 0x30, 'Shop', 0x31, 'the market'),
    'Castle Town Potion Shop Item 2': (0xC71F98, None, 0x31, 'Shop', 0x31, 'the market'),
    'Castle Town Potion Shop Item 3': (0xC71FA0, None, 0x32, 'Shop', 0x31, 'the market'),
    'Castle Town Potion Shop Item 4': (0xC71FA8, None, 0x33, 'Shop', 0x31, 'the market'),
    'Castle Town Potion Shop Item 5': (0xC71FB0, None, 0x34, 'Shop', 0x31, 'the market'),
    'Castle Town Potion Shop Item 6': (0xC71FB8, None, 0x35, 'Shop', 0x31, 'the market'),
    'Castle Town Potion Shop Item 7': (0xC71FC0, None, 0x36, 'Shop', 0x31, 'the market'),
    'Castle Town Potion Shop Item 8': (0xC71FC8, None, 0x37, 'Shop', 0x31, 'the market'),
    'Bazaar Item 1': (0xC71FD0, None, 0x30, 'Shop', 0x2C, 'the market'),
    'Bazaar Item 2': (0xC71FD8, None, 0x31, 'Shop', 0x2C, 'the market'),
    'Bazaar Item 3': (0xC71FE0, None, 0x32, 'Shop', 0x2C, 'the market'),
    'Bazaar Item 4': (0xC71FE8, None, 0x33, 'Shop', 0x2C, 'the market'),
    'Bazaar Item 5': (0xC71FF0, None, 0x34, 'Shop', 0x2C, 'the market'),
    'Bazaar Item 6': (0xC71FF8, None, 0x35, 'Shop', 0x2C, 'the market'),
    'Bazaar Item 7': (0xC72000, None, 0x36, 'Shop', 0x2C, 'the market'),
    'Bazaar Item 8': (0xC72008, None, 0x37, 'Shop', 0x2C, 'the market'),
    'Zora Shop Item 1': (0xC720D0, None, 0x30, 'Shop', 0x2F, 'Zora\'s Domain'),
    'Zora Shop Item 2': (0xC720D8, None, 0x31, 'Shop', 0x2F, 'Zora\'s Domain'),
    'Zora Shop Item 3': (0xC720E0, None, 0x32, 'Shop', 0x2F, 'Zora\'s Domain'),
    'Zora Shop Item 4': (0xC720E8, None, 0x33, 'Shop', 0x2F, 'Zora\'s Domain'),
    'Zora Shop Item 5': (0xC720F0, None, 0x34, 'Shop', 0x2F, 'Zora\'s Domain'),
    'Zora Shop Item 6': (0xC720F8, None, 0x35, 'Shop', 0x2F, 'Zora\'s Domain'),
    'Zora Shop Item 7': (0xC72100, None, 0x36, 'Shop', 0x2F, 'Zora\'s Domain'),
    'Zora Shop Item 8': (0xC72108, None, 0x37, 'Shop', 0x2F, 'Zora\'s Domain'),
    'Goron Shop Item 1': (0xC72110, None, 0x30, 'Shop', 0x2E, 'Goron City'),
    'Goron Shop Item 2': (0xC72118, None, 0x31, 'Shop', 0x2E, 'Goron City'),
    'Goron Shop Item 3': (0xC72120, None, 0x32, 'Shop', 0x2E, 'Goron City'),
    'Goron Shop Item 4': (0xC72128, None, 0x33, 'Shop', 0x2E, 'Goron City'),
    'Goron Shop Item 5': (0xC72130, None, 0x34, 'Shop', 0x2E, 'Goron City'),
    'Goron Shop Item 6': (0xC72138, None, 0x35, 'Shop', 0x2E, 'Goron City'),
    'Goron Shop Item 7': (0xC72140, None, 0x36, 'Shop', 0x2E, 'Goron City'),
    'Goron Shop Item 8': (0xC72148, None, 0x37, 'Shop', 0x2E, 'Goron City'),
}
