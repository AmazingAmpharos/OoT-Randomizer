...
def create_regions(world):
    ...
    world.regions = [
        create_ow_region('Kokiri Forest', ['Kokiri Sword Chest', 'GS Kokiri Know It All House', 'GS Kokiri Bean Patch', 'GS Kokiri House of Twins'], ['Links House', 'Mido House', 'Saria House', 'House of Twins', 'Know It All House', 'Kokiri Shop', 'Deku Tree', 'Lost Woods', 'Lost Woods Bridge', 'Kokiri Forest Storms Grotto']),
        ...
        create_ow_region('Gerudo Valley', ['Gerudo Valley Waterfall Freestanding PoH', 'Gerudo Valley Crate Freestanding PoH', 'GS Gerudo Valley Small Bridge', 'GS Gerudo Valley Bean Patch'], ['Valley Exit', 'Valley River', 'Bridge Crossing']),
        create_ow_region('Gerudo Valley Far Side', ['Gerudo Valley Hammer Rocks Chest', 'GS Gerudo Valley Behind Tent', 'GS Gerudo Valley Pillar'], ['Fortress Entrance']),
        create_ow_region('Gerudo Fortress', ['Gerudo Fortress Rooftop Chest', 'Horseback Archery 1000 Points', 'Horseback Archery 1500 Points', 'Gerudo Fortress Carpenter Rescue', 'GS Gerudo Fortress Archery Range', 'GS Gerudo Fortress Top Floor'], ['Haunted Wasteland Entrance', 'Gerudo Training Grounds Entrance']),
        create_ow_region('Haunted Wasteland', ['Haunted Wasteland Structure Chest', 'GS Wasteland Ruins'], ['Haunted Wasteland Crossing']),
        create_ow_region('Desert Colossus', ['Colossus Freestanding PoH', 'Sheik at Colossus', 'GS Desert Colossus Bean Patch', 'GS Desert Colossus Tree', 'GS Desert Colossus Hill'], ['Colossus Fairy', 'Spirit Temple Entrance']),
        ...
        create_ow_region('Hyrule Castle Grounds', ['Malon Egg', 'GS Hyrule Castle Tree'], ['Hyrule Castle Grounds Exit', 'Hyrule Castle Garden', 'Hyrule Castle Fairy', 'Castle Storms Grotto']),
        ...
        create_ow_region('Ganons Castle Grounds', ['GS Outside Ganon\'s Castle'], ['Ganons Castle Grounds Exit', 'Ganons Castle Fairy', 'Rainbow Bridge']),
        ...
        create_ow_region('Graveyard', ['Graveyard Freestanding PoH', 'Gravedigging Tour', 'GS Graveyard Wall', 'GS Graveyard Bean Patch'], ['Shield Grave', 'Composer Grave', 'Heart Piece Grave', 'Dampes Grave', 'Dampes House', 'Graveyard Exit']),
        ...
        create_ow_region('Death Mountain Crater Upper', ['DM Crater Wall Freestanding PoH', 'GS Death Mounter Crater Crate'], ['Crater Exit', 'Crater Hover Boots', 'Crater Scarecrow', 'Top of Crater Grotto']),
        create_ow_region('Death Mountain Crater Lower', None, ['Crater to City', 'Crater Fairy', 'Crater Bridge', 'Crater Ascent']),
        create_ow_region('Death Mountain Crater Central', ['DM Crater Volcano Freestanding PoH', 'Sheik in Crater', 'GS Death Mounter Bean Patch'], ['Crater Bridge Reverse', 'Fire Temple Entrance']),
        ...
        create_ow_region('Zora River Bottom', ['Zora River Lower Freestanding PoH', 'Zora River Upper Freestanding PoH', 'GS Zora River Ladder'], ['Zora River Exit', 'Zora River Rocks', 'Zora River Adult', 'Zora River Plateau Open Grotto', 'Zora River Plateau Bombable Grotto']),
        create_ow_region('Zora River Top', ['Magic Bean Salesman', 'Frog Ocarina Game', 'Frogs in the Rain', 'GS Zora River Tree'], ['Zora River Downstream', 'Zora River Dive Warp', 'Zora River Waterfall']),
        create_ow_region('Zora River Adult', ['GS Zora River Near Raised Grottos', 'GS Zora River Above Bridge'], ['Zoras Domain Adult Access']),
        ...
        create_ow_region('Zoras Fountain', ['GS Zora\'s Fountain Tree', 'GS Zora\'s Fountain Above the Log'], ['Zoras Fountain Exit', 'Jabu Jabus Belly', 'Zoras Fountain Fairy']),
        create_ow_region('Zoras Domain Frozen', ['King Zora Thawed', 'GS Zora\'s Domain Frozen Waterfall'], ['Zoras Fountain Adult Access']),
        create_ow_region('Outside Ice Cavern', ['Zoras Fountain Iceberg Freestanding PoH', 'Zoras Fountain Bottom Freestanding PoH', 'GS Zora\'s Fountain Hidden Cave'], ['Ice Cavern Entrance']),
        ...
        create_ow_region('Lon Lon Ranch', ['Epona', 'Song from Malon', 'GS Lon Lon Ranch Tree', 'GS Lon Lon Ranch Rain Shed', 'GS Lon Lon Ranch House Window', 'GS Lon Lon Ranch Back Wall'], ['Lon Lon Exit', 'Talon House', 'Ingo Barn', 'Lon Lon Corner Tower', 'Lon Lon Grotto']),
        ...
        create_interior_region('Forest Temple Entry Area', ['Sheik Forest Song', 'GS Lost Woods Above Stage', 'GS Sacred Forest Meadow'], ['Adult Meadow Exit', 'Forest Temple Entrance']),
...
location_table = {'Kokiri Sword Chest': (0x20A6142, None, 0x04E0, 'Chest', 0x55, 'Kokiri Forest'),
                  ...
                  'Impa at Castle': (0x2E8E925, 0x2E8E925, 0x0A, 'Song', 0x4A, 'Hyrule Castle'),
                  'Song from Malon': (0xD7EB53, 0xD7EBCF, 0x09, 'Song', 0x63, 'Lon Lon Ranch'),
                  'Song from Composer Grave': (0x332A871, 0x332A871, 0x0B, 'Song', 0x41, 'the Graveyard'),
                  'Song from Saria': (0x20B1DB1, 0x20B1DB1, 0x08, 'Song', 0x56, 'Sacred Forest Meadow'),
                  'Song from Ocarina of Time': (0x252FC89, 0x252FC89, 0x0C, 'Song', 0x51, 'Hyrule Field'),
                  'Song at Windmill': (0xE42C07, 0xE42B8B, 0x0D, 'Song', 0x48, 'Kakariko'),
                  'Sheik Forest Song': (0x20B0809, 0x20B0809, 0x02, 'Song', 0x56, 'Sacred Forest Meadow'),
                  'Sheik at Temple': (0x2531329, 0x2531329, 0x07, 'Song', 0x43, 'Temple of Time'),
                  'Sheik in Crater': (0x224D7F1, 0x224D7F1, 0x03, 'Song', 0x61, 'Death Mountain Crater'),
                  'Sheik in Ice Cavern': (0x2BEC889, 0x2BEC889, 0x04, 'Song', 0x09, 'Ice Cavern'),
                  'Sheik in Kakariko': (0x2000FE1, 0x2000FE1, 0x06, 'Song', 0x52, 'Kakariko'),
                  'Sheik at Colossus': (0x218C57D, 0x218C57D, 0x05, 'Song', 0x5C, 'Desert Colossus'),
