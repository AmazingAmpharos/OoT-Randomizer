...
def create_regions(world):
    ...
    world.regions = [
        ...
        create_ow_region('Kakariko Village', ['Sheik in Kakariko', 'GS22', 'GS23', 'GS24', 'GS25', 'GS26', 'GS27'], ['Kakariko Exit', 'Carpenter Boss House', 'House of Skulltulla', 'Impas House', 'Impas House Back', 'Windmill', 'Kakariko Bazaar', 'Kakariko Shooting Gallery', 'Bottom of the Well',
...
location_table = {'Kokiri Sword Chest': (0x20A6142, 0x04E0, 'Chest'),
                  ...
                  'King Zora Thawed': (None, None, 'NPC'),
