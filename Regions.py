...
def create_regions(world):
    ...
    world.regions = [
        ...
        create_ow_region('Gerudo Valley Far Side', ['GS88', 'GS89'], ['Fortress Entrance']),
        ...
        create_dungeon_region('Ganons Castle Tower', ['Ganon']),
...
location_table = {'Kokiri Sword Chest': (0x20A6142, None, 0x04E0, 'Chest'),
                  ...
                  'Fire Temple Boulder Maze Bombable Pit': (0x231B0D4, None, 0x584B, 'Chest'),
                  ...
                  'Gerudo Training Grounds Near Scarecrow Chest': (0x28D00AE, None, 0x8844, 'Chest'),
                  ...
                  'Impa at Castle': (0x2E8E961, 0x2E8E979, 0x0A, 'Song'),
                  'Song from Malon': (0xD7EB53, 0xD7EBCF, 0x09, 'Song'),
                  'Song from Composer Grave': (0x332A8AD, 0x332A8C5, 0x0B, 'Song'),
                  'Song from Saria': (0x20B1DED, 0x20B1E05, 0x08, 'Song'),
                  'Song from Ocarina of Time': (0x252FCC5, 0x252FCDD, 0x0C, 'Song'),
                  'Song at Windmill': (0xE42C07, 0xE42B8B, 0x0D, 'Song'),
                  'Sheik Forest Song': (0x20B082D, 0x20B0845, 0x02, 'Song'),
                  'Sheik at Temple': (0x253137D, 0x2531395, 0x07, 'Song'),
                  'Sheik in Crater': (0x224D815, 0x224D82D, 0x03, 'Song'),
                  'Sheik in Ice Cavern': (0x2BEC8F5, 0x2BEC90D, 0x04, 'Song'),
                  'Sheik in Kakariko': (0x2001035, 0x200104D, 0x06, 'Song'),
                  'Sheik at Colossus': (0x218C5A1, 0x218C5B9, 0x05, 'Song'),
                  'Gift from Saria': (None, None, None, 'NPC'),
                  'Zeldas Letter': (None, None, None, 'NPC'),
                  'Mountain Summit Fairy Reward': (None, None, None, 'Fairy'),
                  'Hyrule Castle Fairy Reward': (0xC8BD09, 0x2D21E95, None, 'Special'),
                  'Zoras Fountain Fairy Reward': (0xC8BD08, 0x2D205AD, None, 'Special'),
                  'Desert Colossus Fairy Reward': (0xC8BD0A, 0x2D2238D, None, 'Special'),
                  'Zelda': (0xC8D557, 0x253391D, None, 'Special'),
                  'Treasure Chest Game': (0xBEF152, None, None, 'Special'),
                  'Darunias Joy': (0xCF1BFF, None, 0x54, 'NPC'),
                  'Diving Minigame': (0xE01A2B, None, 0x37, 'NPC'),
                  'Child Fishing': (0xDCBFBF, None, 0x3E, 'NPC'),
                  'Adult Fishing': (0xDCC087, None, 0x38, 'NPC'),
                  'Diving in the Lab': (0xE2CB97, None, 0x3E, 'NPC'),
                  'Link the Goron': (0xED30EB, None, 0x2C, 'NPC'),
                  ...
                  'Dog Lady': (0xE65163, None, 0x3E, 'NPC'),
                  'Skull Kid': (0xDF0F33, None, 0x3E, 'NPC'),
                  ...
                  'Horseback Archery 1000 Points': (0xE12BC3, None, 0x30, 'NPC'),
                  'Horseback Archery 1500 Points': (0xE12B6F, None, 0x3E, 'NPC'),
                  ...
                  'Lake Hylia Sun': (0xDE1107, None, 0x58, 'NPC'),
                  'Magic Bean Salesman': (None, None, None, 'Event'),
                  'Underwater Bottle': (None, None, None, 'Event'),
