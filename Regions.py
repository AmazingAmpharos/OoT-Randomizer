...
location_table = {'Kokiri Sword Chest': (0x20A6142, None, 0x04E0, 'Chest', 0x55),
                  ...
                  'Redead Grotto Chest': (0x26CF076, None, 0x7ACA, 'Chest', 0x3E),
                  'Wolfos Grotto Chest': (0x26EB076, None, 0x7AB1, 'Chest', 0x3E),
                  ...
                  'Field West Castle Town Grotto Chest': (None, None, 0x00, 'Chest', 0x3E),
                  'Remote Southern Grotto Chest': (None, None, 0x02, 'Chest', 0x3E),
                  'Field Near Lake Outside Fence Grotto Chest': (None, None, 0x03, 'Chest', 0x3E),
                  'Kakariko Back Grotto Chest': (None, None, 0x08, 'Chest', 0x3E),
                  'Zora River Plateau Open Grotto Chest': (None, None, 0x09, 'Chest', 0x3E),
                  'Kokiri Forest Storms Grotto Chest': (None, None, 0x0C, 'Chest', 0x3E),
                  'Lost Woods Generic Grotto Chest': (None, None, 0x14, 'Chest', 0x3E),
                  'Mountain Storms Grotto Chest': (None, None, 0x17, 'Chest', 0x3E),
                  'Top of Crater Grotto Chest': (None, None, 0x1A, 'Chest', 0x3E),
                  ...
                  'Hyrule Castle Fairy Reward': (0x3481401, None, 0x5C, 'NPC', 0x3D),
                  'Zoras Fountain Fairy Reward': (0x3481400, None, 0x5D, 'NPC', 0x3D),
                  'Desert Colossus Fairy Reward': (0x3481402, None, 0x5E, 'NPC', 0x3D),
                  'Zelda': (0x3481403, None, 0x5A, 'NPC', 0x43),
                  'Treasure Chest Game': (None, None, 0x76, 'Special', 0x10),
                  ...
                  'Ocarina Memory Game': (0xDF264F, None, 0x76, 'NPC', 0x5B),
                  ...
                  'Frog Ocarina Game': (0xDB13D3, None, 0x76, 'NPC', 0x54),
                  ...
                  'Deku Theater Skull Mask': (0xEC9A87, None, 0x77, 'NPC', 0x3E),
                  'Deku Theater Mask of Truth': (0xEC9CE7, None, 0x7A, 'NPC', 0x3E),
                  'Deku Salesman Woods': (0xDF8073, None, 0x77, 'NPC', 0x5B),
                  'Deku Salesman Lost Woods Grotto': (0xDF80E7, None, 0x79, 'NPC', 0x3E),
                  'Deku Salesman Hyrule Field Grotto': (0xDF86AB, None, 0x3E, 'NPC', 0x3E),
                  ...
                  'Queen Gohma Heart': (None, None, 0x4F, 'BossHeart', 0x11),
                  'King Dodongo Heart': (None, None, 0x4F, 'BossHeart', 0x12),
                  'Barinade Heart': (None, None, 0x4F, 'BossHeart', 0x13),
                  'Phantom Ganon Heart': (None, None, 0x4F, 'BossHeart', 0x14),
                  'Volvagia Heart': (None, None, 0x4F, 'BossHeart', 0x15),
                  'Morpha Heart': (None, None, 0x4F, 'BossHeart', 0x16),
                  'Twinrova Heart': (None, None, 0x4F, 'BossHeart', 0x17),
                  'Bongo Bongo Heart': (None, None, 0x4F, 'BossHeart', 0x18),
