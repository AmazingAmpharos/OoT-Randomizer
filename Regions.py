...
location_table = {
    ...
    'Bazaar Item 1': (shop_address(4, 0), None, 0x30, 'Shop', 0x2C, 'the market'),
    'Bazaar Item 2': (shop_address(4, 1), None, 0x31, 'Shop', 0x2C, 'the market'),
    'Bazaar Item 3': (shop_address(4, 2), None, 0x32, 'Shop', 0x2C, 'the market'),
    'Bazaar Item 4': (shop_address(4, 3), None, 0x33, 'Shop', 0x2C, 'the market'),
    'Bazaar Item 5': (shop_address(4, 4), None, 0x34, 'Shop', 0x2C, 'the market'),
    'Bazaar Item 6': (shop_address(4, 5), None, 0x35, 'Shop', 0x2C, 'the market'),
    'Bazaar Item 7': (shop_address(4, 6), None, 0x36, 'Shop', 0x2C, 'the market'),
    'Bazaar Item 8': (shop_address(4, 7), None, 0x37, 'Shop', 0x2C, 'the market'),
