...
def create_regions(world):
    ...
    world.regions = [
        ...
        create_ow_region('Zora River Front', ['GS Zora River Tree'], ['Zora River Rocks', 'Zora River Adult', 'Zora River Exit']),
        create_ow_region('Zora River Child', ['Magic Bean Salesman', 'Frog Ocarina Game', 'Frogs in the Rain', 'GS Zora River Ladder'], ['Zora River Child to Shared', 'Zora River Waterfall']),
        create_ow_region('Zora River Adult', ['GS Zora River Near Raised Grottos', 'GS Zora River Above Bridge'], ['Zoras Domain Adult Access', 'Zora River Adult to Shared']),
        create_ow_region('Zora River Shared', ['Zora River Lower Freestanding PoH', 'Zora River Upper Freestanding PoH'], ['Zora River Downstream', 'Zora River Plateau Open Grotto', 'Zora River Plateau Bombable Grotto', 'Zora River Dive Warp']),
