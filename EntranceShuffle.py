...
entrance_shuffle_table = [
    ...
    ('Interior',        ('Kak Impas Ledge -> Impas House Back',                        { 'index': 0x05C8 }),
                        ('Impas House Back -> Kak Impas Ledge',                        { 'index': 0x05DC })),
    ...
    ('Interior',        ('Hyrule Castle Grounds -> HC Great Fairy',                         { 'index': 0x0578 }),
                        ('HC Great Fairy -> Castle Grounds',                                { 'index': 0x0340, 'dynamic_address': 0xBEFD80 })),
    ...
    ('Grotto',          ('Hyrule Field -> HF Valley Grotto',                                { 'grotto_id': 0x11, 'entrance': 0x05A8, 'content': 0xE4, 'scene': 0x51 }),
                        ('HF Valley Grotto -> Hyrule Field',                                { 'grotto_id': 0x11 })),
    ...
    if entrance_placed == None or (entrance_placed != None and entrance_placed.type in ['Interior', 'SpecialInterior', 'Overworld']):
        ...
        for world in worlds:
            ...
            if world.shuffle_cows:
                ...
                impas_back_entrance = get_entrance_replacing(world.get_region('Impas House Back'), 'Kak Impas Ledge -> Impas House Back')
