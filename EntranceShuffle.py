...
entrance_shuffle_table = [
    ...
    ('Interior',        ('GV Fortress Side -> Carpenter Tent',                        { 'index': 0x03A0 }),
                        ('Carpenter Tent -> GV Fortress Side',                        { 'index': 0x03D0 })),
    ...
    ('Interior',        ('Kakariko Village Backyard -> Kak Odd Medicine Building',              { 'index': 0x0072 }),
                        ('Kak Odd Medicine Building -> Kakariko Village Backyard',              { 'index': 0x034D })),
    ...
    ('Interior',        ('Lon Lon Ranch -> Talons House',                                   { 'index': 0x004F }),
                        ('Talons House -> Lon Lon Ranch',                                   { 'index': 0x0378 })),
    ...
    ('Interior',        ('Kakariko Village -> Kak Adult Shooting Gallery',                   { 'index': 0x003B }),
                        ('Kak Adult Shooting Gallery -> Kakariko Village',                   { 'index': 0x0463, 'dynamic_address': 0xBEFD7A })),
    ...
    ('SpecialInterior', ('Kakariko Village Backyard -> Kak Potion Shop Back',          { 'index': 0x03EC }),
                        ('Kak Potion Shop Back -> Kakariko Village Backyard',          { 'index': 0x04FF })),
    ...
    ('Grotto',          ('DMC Upper Nearby -> Top of Crater Grotto',      { 'grotto_id': 0x06, 'entrance': 0x003F, 'content': 0x7A, 'scene': 0x61 }),
                        ('Top of Crater Grotto -> DMC Upper Local',       { 'grotto_id': 0x06 })),
    ...
    ('Grotto',          ('Kakariko Village Backyard -> Kak Back Grotto',               { 'grotto_id': 0x0A, 'entrance': 0x003F, 'content': 0x28, 'scene': 0x52 }),
                        ('Kak Back Grotto -> Kakariko Village Backyard',               { 'grotto_id': 0x0A })),
    ('Grotto',          ('Kakariko Village -> Kak Bombable Grotto',                    { 'grotto_id': 0x0B, 'entrance': 0x05A0, 'content': 0xE7, 'scene': 0x52 }),
                        ('Kak Bombable Grotto -> Kakariko Village',                    { 'grotto_id': 0x0B })),
    ...
    if (entrance_placed == None and worlds[0].shuffle_special_indoor_entrances) or \
       (entrance_placed != None and entrance_placed.type in ['SpecialInterior', 'Overworld']):
        ...
        for world in worlds:
            ...
            potion_back_entrance = get_entrance_replacing(world.get_region('Kak Potion Shop Back'), 'Kakariko Village Backyard -> Kak Potion Shop Back')
