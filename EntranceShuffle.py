...
entrance_shuffle_table = [
    ...
    ('Interior',        ('Death Mountain Crater Lower Limited -> Crater Fairy',             { 'index': 0x04BE }),
    ...
    ('Grotto',          ('Death Mountain Crater Lower Limited -> DMC Hammer Grotto',        { 'grotto_id': 0x05, 'entrance': 0x05A4, 'content': 0xF9, 'scene': 0x61 }),
                        ('DMC Hammer Grotto -> Death Mountain Crater Lower',                { 'grotto_id': 0x05 })),
    ('Grotto',          ('Death Mountain Crater Upper Limited -> Top of Crater Grotto',     { 'grotto_id': 0x06, 'entrance': 0x003F, 'content': 0x7A, 'scene': 0x61 }),
    ...
    ('Overworld',       ('Darunias Chamber -> Death Mountain Crater Lower',                 { 'index': 0x0246 }),
                        ('Death Mountain Crater Lower Limited -> Darunias Chamber',         { 'index': 0x01C1 })),
    ('Overworld',       ('Death Mountain Summit -> Death Mountain Crater Upper',            { 'index': 0x0147 }),
                        ('Death Mountain Crater Upper Limited -> Death Mountain Summit',    { 'index': 0x01BD })),
