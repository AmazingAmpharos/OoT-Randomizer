...
item_table = {'Bow': (True, False, None, None, 0x83),
              ...
              'Buy Deku Nut (5)': (False, True, 'Shop', 0x00BB, 0x00), 
              'Buy Arrows (30)': (False, True, 'Shop', 0x00D8, 0x01), 
              'Buy Arrows (50)': (False, True, 'Shop', 0x00D8, 0x02), 
              'Buy Bombs (5)': (False, True, 'Shop', 0x00CE, 0x03), 
              'Buy Deku Nut (10)': (False, True, 'Shop', 0x00BB, 0x04), 
              'Buy Deku Stick (1)': (False, True, 'Shop', 0x00C7, 0x05), 
              'Buy Bombs (10)': (False, True, 'Shop', 0x00CE, 0x06), 
              'Buy Fish': (False, True, 'Shop', 0x00F4, 0x07), 
              'Buy Red Potion': (False, True, 'Shop', 0x00EB, 0x08), 
              'Buy Green Potion': (False, True, 'Shop', 0x00EB, 0x09), 
              'Buy Blue Potion': (False, True, 'Shop', 0x00EB, 0x0A), 
#              'Buy Giant's Knife': (False, True, 'Shop', 0x00F8, 0x0B), 
              'Buy Hylian Shield': (True, False, 'Shop', 0x00DC, 0x0C), 
              'Buy Deku Shield': (True, False, 'Shop', 0x00CB, 0x0D), 
              'Buy Goron Tunic': (True, False, 'Shop', 0x00F2, 0x0E), 
              'Buy Zora Tunic': (True, False, 'Shop', 0x00F2, 0x0F), 
              'Buy Heart': (False, True, 'Shop', 0x00B7, 0x10), 
#              'Buy Milk Bottle': (False, True, 'Shop', 0x00DF, 0x11), 
#              'Buy Weird Egg': (False, True, 'Shop', 0x00DA, 0x12), 
#              'Buy Milk Bottle': (False, True, 'Shop', 0x00DF, 0x13), 
#              'Buy Weird Egg': (False, True, 'Shop', 0x00DA, 0x14), 
              'Buy Bombchu (10)': (True, False, 'Shop', 0x00D9, 0x15), 
              'Buy Bombchu (20)': (True, False, 'Shop', 0x00D9, 0x16), 
#              'Buy Bombchu (20)': (False, True, 'Shop', 0x00D9, 0x17), 
              'Buy Bombchu (5)': (True, False, 'Shop', 0x00D9, 0x18), 
#              'Buy Bombchu (10)': (False, True, 'Shop', 0x00D9, 0x19), 
#              'Buy Bombchu (20)': (False, True, 'Shop', 0x00D9, 0x1A), 
#              'Buy Bombchu (20)': (False, True, 'Shop', 0x00D9, 0x1B), 
#              'Buy Bombchu (10)': (False, True, 'Shop', 0x00D9, 0x1C), 
              'Buy Deku Seeds (30)': (False, True, 'Shop', 0x0119, 0x1D), 
#              'Buy Keaton Mask': (False, True, 'Shop', 0x0134, 0x1E), 
#              'Buy Spooky Mask': (False, True, 'Shop', 0x0135, 0x1F), 
#              'Buy Skull Mask': (False, True, 'Shop', 0x0136, 0x20), 
#              'Buy Bunny Hood': (False, True, 'Shop', 0x0137, 0x21), 
#              'Buy Mask of Truth': (False, True, 'Shop', 0x0138, 0x22), 
#              'Buy Zora Mask': (False, True, 'Shop', 0x0151, 0x23), 
#              'Buy Goron Mask': (False, True, 'Shop', 0x0150, 0x24), 
#              'Buy Gerudo Mask': (False, True, 'Shop', 0x0152, 0x25), 
              'Sold Out': (False, True, 'Shop', 0x0148, 0x26), 
              'Buy Blue Fire': (True, False, 'Shop', 0x0173, 0x27), 
              'Buy Bottle Bug': (False, True, 'Shop', 0x0174, 0x28), 
#              'Buy Big Poe': (False, True, 'Shop', 0x0176, 0x29), 
#              'Buy Poe': (False, True, 'Shop', 0x0176, 0x2A), 
              'Buy Fairy\'s Spirit': (False, True, 'Shop', 0x0177, 0x2B), 
              'Buy Arrow (10)': (False, True, 'Shop', 0x00D8, 0x2C), 
              'Buy Bombs (20)': (False, True, 'Shop', 0x00CE, 0x2D), 
              'Buy Bombs (30)': (False, True, 'Shop', 0x00CE, 0x2E), 
#              'Buy Bombs (5)': (False, True, 'Shop', 0x00CE, 0x2F), 
#              'Buy Red Potion': (False, True, 'Shop', 0x00EB, 0x30), 
#              'Buy Red Potion': (False, True, 'Shop', 0x00EB, 0x31),
}
