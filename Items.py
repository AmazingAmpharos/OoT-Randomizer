...
item_table = {'Bow': (True, False, None, None, 0x83),
              ...
              'Deku Stick Capacity': (False, True, None, None, 0x88),
              'Deku Nut Capacity': (False, True, None, None, 0x87),
              'Stone of Agony': (True, False, None, 0x0720, 0x39),
              'Piece of Heart': (False, False, None, 0x07C0, 0x3E),
              'Recovery Heart': (False, True, None, None, 0xB6),
              'Arrows (5)': (False, True, None, None, 0xB7),
              'Arrows (10)': (False, True, None, None, 0xB8),
              'Arrows (30)': (False, True, None, None, 0xB9),
              'Bombs (5)': (False, True, None, None, 0xBA),
              'Bombs (10)': (False, True, None, None, 0xBB),
              'Bombs (20)': (False, True, None, None, 0xBC),
              'Bombchus (5)': (False, False, None, 0x0D40, 0x6A),
              'Bombchus (10)': (False, False, None, 0x0060, 0x03),
              'Bombchus (20)': (False, False, None, 0x0D60, 0x6B),
              'Deku Nuts (5)': (False, True, None, None, 0xBD),
              'Deku Nuts (10)': (False, True, None, None, 0xBE),
