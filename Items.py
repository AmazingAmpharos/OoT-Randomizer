...
item_table = {'Bow': (True, False, None, 0x0620, 0x31),
              ...
              'Kokiri Emerald': (True, False, 'Event', 0x006C, None),
              'Goron Ruby': (True, False, 'Event', 0x006D, None),
              'Zora Sapphire': (True, False, 'Event', 0x006E, None),
              'Forest Medallion': (True, False, 'Event', 0x0066, None),
              'Fire Medallion': (True, False, 'Event', 0x0067, None),
              'Water Medallion': (True, False, 'Event', 0x0068, None),
              'Spirit Medallion': (True, False, 'Event', 0x0069, None),
              'Shadow Medallion': (True, False, 'Event', 0x006A, None),
