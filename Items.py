...
item_table = {'Bow': (True, False, None, None, 0x83),
              ...
              'Double Defense': (False, False, None, None, 0xC1),
              ...
              'Boss Key (Forest Temple)': (False, False, 'BossKey', None, 0x92),
              'Boss Key (Fire Temple)': (False, False, 'BossKey', None, 0x93),
              'Boss Key (Water Temple)': (False, False, 'BossKey', None, 0x94),
              'Boss Key (Spirit Temple)': (False, False, 'BossKey', None, 0x95),
              'Boss Key (Shadow Temple)': (False, False, 'BossKey', None, 0x96),
              'Boss Key (Ganons Castle)': (False, False, 'BossKey', None, 0x97),
              ...
              'Small Key (Forest Temple)': (False, False, 'SmallKey', None, 0xAC),
              'Small Key (Fire Temple)': (False, False, 'SmallKey', None, 0xAD),
              'Small Key (Water Temple)': (False, False, 'SmallKey', None, 0xAE),
              'Small Key (Spirit Temple)': (False, False, 'SmallKey', None, 0xAF),
              'Small Key (Shadow Temple)': (False, False, 'SmallKey', None, 0xB0),
              'Small Key (Bottom of the Well)': (False, False, 'SmallKey', None, 0xB1),
              'Small Key (Gerudo Training Grounds)': (False, False, 'SmallKey', None, 0xB2),
              'Small Key (Gerudo Fortress)': (False, False, 'SmallKey', None, 0xB3),
              'Small Key (Ganons Castle)': (False, False, 'SmallKey', None, 0xB4),
