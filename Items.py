...
item_data = {#'Bow': [0x4C, 0x80, 0x17, 0x57, 0x00, 0xBE],
             ...
             # 'Deku Nut Capacity': [0x9A, 0x80, 0xEE, 0xA7, 0x00, 0xBB],
              ...
              'Kokiri Emerald': [0x04, 0xA5, 0x80],
              'Goron Ruby': [0x08, 0xA5, 0x81],
              'Zora Sapphire': [0x10, 0xA5, 0x82],
              'Forest Medallion': [0x01, 0xA7, 0x3E],
              'Fire Medallion': [0x02, 0xA7, 0x3C],
              'Water Medallion': [0x04, 0xA7, 0x3D],
              'Spirit Medallion': [0x08, 0xA7, 0x3F],
              'Shadow Medallion': [0x10, 0xA7, 0x41],
              'Light Medallion': [0x20, 0xA7, 0x40]}