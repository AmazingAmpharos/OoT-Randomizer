...
item_table = {
    ...
    'Bottle': (True, False, None, 0x01E0, 0x0F, 0x00C5, 0x01),
    'Bottle with Letter': (True, False, None, 0x02A0, 0x15, 0x010B, 0x45),
    'Bottle with Milk': (True, False, None, 0x0280, 0x14, 0x00DF, 0x30),
    'Bottle with Red Potion': (True, False, None, None, 0x89, 0x00C5, 0x01),
    'Bottle with Green Potion': (True, False, None, None, 0x8A, 0x00C5, 0x01),
    'Bottle with Blue Potion': (True, False, None, None, 0x8B, 0x00C5, 0x01),
    'Bottle with Fairy': (True, False, None, None, 0x8C, 0x00C5, 0x01),
    'Bottle with Fish': (True, False, None, None, 0x8D, 0x00C5, 0x01),
    'Bottle with Blue Fire': (True, False, None, None, 0x8E, 0x00C5, 0x01),
    'Bottle with Bugs': (True, False, None, None, 0x8F, 0x00C5, 0x01),
    'Bottle with Poe': (True, False, None, None, 0x91, 0x00C5, 0x01),
